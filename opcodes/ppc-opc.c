...
static unsigned long insert_pxinv (unsigned long, long, ppc_cpu_t, const char **);
static long extract_pxinv (unsigned long, ppc_cpu_t, int *);
...
#define OBF BFF + 1
  ...
  /* The BIX field in a PPE FCB form instruction.  */
#define BIX OBF + 1
  { 0x3, 21, NULL, NULL, 0 },

  /* The PX field in a PPE FCB form instruction.  */
#define PX BIX + 1
  { 0x1, 23, NULL, NULL, 0 },
  /* The PX field in a PPE FCB form instruction.  */

#define PXINV PX + 1
  { 0x1, 23, insert_pxinv, extract_pxinv, 0 },

  /* The UIX field in a PPE FCB form instruction.  */
#define UIX PXINV + 1
  { 0x1f, 11, NULL, NULL, 0 },

  /* The BNX field in a PPE FCB form instruction.  */
#define BNX UIX + 1
  { 0x1f, 11, NULL, NULL, 0 },

  /* The BFA field in a PPE FCB form instruction.  */
#define BFA BNX + 1
...
#define B24 B15 + 1
  ...
  /* The BDX field in a PPE FCB form instruction.   The lowest bit is
     forced to zero. */
#define BDX B24 + 1
  { 0xffc, -1, NULL, NULL, PPC_OPERAND_RELATIVE | PPC_OPERAND_SIGNED },
...
#define DS DQ + 1
  ...
  /* The DD field in a DS form instruction. This is like D, but the
   * lower three bits are forced to zero. */
#define DD DS + 1
  { 0xfff8, 0, NULL, NULL,
    PPC_OPERAND_PARENS | PPC_OPERAND_SIGNED | PPC_OPERAND_DS },
...
#define RAOPT RAS + 1
  ...
  /* The VDA field in an X form (PPE specific) instruction */
#define VDA RAOPT + 1
  { 0x1f, 16, NULL, NULL, PPC_OPERAND_GPVDR},
...
#define RD RS
  ...
  /* The VDS / DVT field in a D form (PPE specific)
     instruction */
#define VDS RS + 1
#define VDT VDS
#define VDT_MASK (0x1f << 21)
  { 0x1f, 21,  NULL, NULL, PPC_OPERAND_GPVDR },
...
#define ERAT_T UIM + 1
  { 0x7, 21, NULL, NULL, 0 },
#define B6_B15 ERAT_T + 1
  { 0x7fff, 11, NULL, NULL, 0 },
};
...
/* The px field in PPE42 instructions may be inverted.  We must add the ability
 *  to invert the bit when encoding and dissasembly. */
/*{ 0x1, 23, insert_pxinv, extract_pxinv, 0 }, */
static unsigned long
insert_pxinv (unsigned long insn,
	    long value,
	    ppc_cpu_t dialect ATTRIBUTE_UNUSED,
	    const char **errmsg ATTRIBUTE_UNUSED)
{
    return insn | (((~value) & 0x1) << 23);
}

static long
extract_pxinv (unsigned long insn,
	     ppc_cpu_t dialect ATTRIBUTE_UNUSED,
	     int *invalid ATTRIBUTE_UNUSED)
{
  return ((insn >> 23) & 0x1) ? 0 : 1;
}
...
valid_bo (long value, ppc_cpu_t dialect, int extract)
{
  ...
  if (dialect & (PPC_OPCODE_PPE | PPC_OPCODE_PPEX))
    return 0 == value;
...
/* A PPE fused compare branch using ext mnemonic form instruction.  */
#define FCBEM(op, so, px, bix, lk) (OP (op) \
                            | (((so) & 0x3) << 24) \
                            | (((px) & 0x1) << 23) \
                            | (((bix) & 0x3) << 21) \
                            | ((lk) & 1))
#define FCBEM_MASK  FCBEM(0x3f,0x3,1,0x3,1)

/* A PPE fused compare branch using ext mnemonic form instruction.  */
#define FCBEMZ(op, so, px, bix, uix, lk) (OP (op) \
                            | (((so) & 0x3) << 24) \
                            | (((px) & 0x1) << 23) \
                            | (((bix) & 0x3) << 21) \
                            | (((unsigned long)(uix) & 0x1f) << 11) \
                            | ((lk) & 1))
#define FCBEMZ_MASK  FCBEMZ(0x3f,0x3,1,0x3,0x1f,1)

/* A PPE fused branch form instruction.  */
#define FB(op, so, sso, lk) (OP (op) \
                            | (((so) & 0x3) << 24) \
                            | (((sso) & 0x3) << 21) \
                            | ((lk) & 1))
#define FB_MASK  FB(0x3f,0x3,0x3,1)

/* A PPE fused compare branch form instruction.  */
#define FCB(op, so, lk) (OP (op) \
                         | (((so) & 0x3) << 24) \
                         | ((lk) & 1))
#define FCB_MASK  FCB(0x3f,0x3,1)
...
#define PPE     PPC_OPCODE_PPE | PPC_OPCODE_PPEX
#define PPEX    PPC_OPCODE_PPEX
...
// FCBEM(op, so, px, bix, lk)

// PX=1, BIX=0: less than is true
{"cmpwblt",     FCBEM(1,0,1,0,0),      FCBEM_MASK,     PPE,    PPCNONE,        {RA, RB, BDX}},
{"cmpwbltl",    FCBEM(1,0,1,0,1),      FCBEM_MASK,     PPE,    PPCNONE,        {RA, RB, BDX}},
// PX=0, BIX=1: not greater than is false (less than or eq)
{"cmpwble",     FCBEM(1,0,0,1,0),      FCBEM_MASK,     PPE,    PPCNONE,        {RA, RB, BDX}},
{"cmpwblel",    FCBEM(1,0,0,1,1),      FCBEM_MASK,     PPE,    PPCNONE,        {RA, RB, BDX}},
// PX=1, BIX=1: greater than is True
{"cmpwbgt",     FCBEM(1,0,1,1,0),      FCBEM_MASK,     PPE,    PPCNONE,        {RA, RB, BDX}},
{"cmpwbgtl",    FCBEM(1,0,1,1,1),      FCBEM_MASK,     PPE,    PPCNONE,        {RA, RB, BDX}},
// PX=0, BIX=0: not less than is false (greater than or eq)
{"cmpwbge",     FCBEM(1,0,0,0,0),      FCBEM_MASK,     PPE,    PPCNONE,        {RA, RB, BDX}},
{"cmpwbgel",    FCBEM(1,0,0,0,1),      FCBEM_MASK,     PPE,    PPCNONE,        {RA, RB, BDX}},
// PX=1, BIX=2: eq is true
{"cmpwbeq",     FCBEM(1,0,1,2,0),      FCBEM_MASK,     PPE,    PPCNONE,        {RA, RB, BDX}},
{"cmpwbeql",    FCBEM(1,0,1,2,1),      FCBEM_MASK,     PPE,    PPCNONE,        {RA, RB, BDX}},
// PX=0, BIX=2: eq is false
{"cmpwbne",     FCBEM(1,0,0,2,0),      FCBEM_MASK,     PPE,    PPCNONE,        {RA, RB, BDX}},
{"cmpwbnel",    FCBEM(1,0,0,2,1),      FCBEM_MASK,     PPE,    PPCNONE,        {RA, RB, BDX}},
// PX=0, BIX=3: subtract and branch if eq = 0
{"subwbz",      FCBEM(1,0,1,3,0),      FCBEM_MASK,     PPE,    PPCNONE,        {RA, RB, BDX}},
{"subwbzl",     FCBEM(1,0,1,3,1),      FCBEM_MASK,     PPE,    PPCNONE,        {RA, RB, BDX}},
// PX=1, BIX=3: // PX=0, BIX=3: subtract and branch if eq = 1
{"subwbnz",     FCBEM(1,0,0,3,0),      FCBEM_MASK,     PPE,    PPCNONE,        {RA, RB, BDX}},
{"subwbnzl",    FCBEM(1,0,0,3,1),      FCBEM_MASK,     PPE,    PPCNONE,        {RA, RB, BDX}},

// PX=1, BIX=0: less than is true
{"cmplwblt",    FCBEM(1,1,1,0,0),      FCBEM_MASK,     PPE,    PPCNONE,        {RA, RB, BDX}},
{"cmplwbltl",   FCBEM(1,1,1,0,1),      FCBEM_MASK,     PPE,    PPCNONE,        {RA, RB, BDX}},
// PX=0, BIX=1: not greater than is false (less than or eq)
{"cmplwble",    FCBEM(1,1,0,1,0),      FCBEM_MASK,     PPE,    PPCNONE,        {RA, RB, BDX}},
{"cmplwblel",   FCBEM(1,1,0,1,1),      FCBEM_MASK,     PPE,    PPCNONE,        {RA, RB, BDX}},
// PX=1, BIX=1: greater than is True
{"cmplwbgt",    FCBEM(1,1,1,1,0),      FCBEM_MASK,     PPE,    PPCNONE,        {RA, RB, BDX}},
{"cmplwbgtl",   FCBEM(1,1,1,1,1),      FCBEM_MASK,     PPE,    PPCNONE,        {RA, RB, BDX}},
// PX=0, BIX=0: not less than is false (greater than or eq)
{"cmplwbge",    FCBEM(1,1,0,0,0),      FCBEM_MASK,     PPE,    PPCNONE,        {RA, RB, BDX}},
{"cmplwbgel",   FCBEM(1,1,0,0,1),      FCBEM_MASK,     PPE,    PPCNONE,        {RA, RB, BDX}},
// PX=1, BIX=2: eq is true
{"cmplwbeq",    FCBEM(1,1,1,2,0),      FCBEM_MASK,     PPE,    PPCNONE,        {RA, RB, BDX}},
{"cmplwbeql",   FCBEM(1,1,1,2,1),      FCBEM_MASK,     PPE,    PPCNONE,        {RA, RB, BDX}},
// PX=0, BIX=2: eq is false
{"cmplwbne",    FCBEM(1,1,0,2,0),      FCBEM_MASK,     PPE,    PPCNONE,        {RA, RB, BDX}},
{"cmplwbnel",   FCBEM(1,1,0,2,1),      FCBEM_MASK,     PPE,    PPCNONE,        {RA, RB, BDX}},
// PX=0, BIX=3: subtract and branch if eq = 0
{"sublwbz",     FCBEM(1,1,1,3,0),      FCBEM_MASK,     PPE,    PPCNONE,        {RA, RB, BDX}},
{"sublwbzl",    FCBEM(1,1,1,3,1),      FCBEM_MASK,     PPE,    PPCNONE,        {RA, RB, BDX}},
// PX=1, BIX=3: // PX=0, BIX=3: subtract and branch if eq = 1
{"sublwbnz",    FCBEM(1,1,0,3,0),      FCBEM_MASK,     PPE,    PPCNONE,        {RA, RB, BDX}},
{"sublwbnzl",   FCBEM(1,1,0,3,1),      FCBEM_MASK,     PPE,    PPCNONE,        {RA, RB, BDX}},

// branch compare immediate to 0.....
// from above #define FCBEMZ(op, so, px, bix, uix=0, lk) (OP (op)
// PX=1, BIX=0: less than is true
{"bwltz",       FCBEMZ(1,2,1,0,0,0),   FCBEMZ_MASK,    PPE,    PPCNONE,        {RA, BDX}},
{"bwltzl",      FCBEMZ(1,2,1,0,0,1),   FCBEMZ_MASK,    PPE,    PPCNONE,        {RA, BDX}},
// PX=0, BIX=1: not greater than is false (less than or eq)
{"bwlez",       FCBEMZ(1,2,0,1,0,0),   FCBEMZ_MASK,    PPE,    PPCNONE,        {RA, BDX}},
{"bwlezl",      FCBEMZ(1,2,0,1,0,1),   FCBEMZ_MASK,    PPE,    PPCNONE,        {RA, BDX}},
// PX=1, BIX=1: greater than is True
{"bwgtz",       FCBEMZ(1,2,1,1,0,0),   FCBEMZ_MASK,    PPE,    PPCNONE,        {RA, BDX}},
{"bwgtzl",      FCBEMZ(1,2,1,1,0,1),   FCBEMZ_MASK,    PPE,    PPCNONE,        {RA, BDX}},
// PX=0, BIX=0: not less than is false (greater than or eq)
{"bwgez",       FCBEMZ(1,2,0,0,0,0),   FCBEMZ_MASK,    PPE,    PPCNONE,        {RA, BDX}},
{"bwgezl",      FCBEMZ(1,2,0,0,0,1),   FCBEMZ_MASK,    PPE,    PPCNONE,        {RA, BDX}},
// PX=1, BIX=2: eq is true
{"bwz",         FCBEMZ(1,2,1,2,0,0),   FCBEMZ_MASK,    PPE,    PPCNONE,        {RA, BDX}},
{"bwzl",        FCBEMZ(1,2,1,2,0,1),   FCBEMZ_MASK,    PPE,    PPCNONE,        {RA, BDX}},
// PX=0, BIX=2: eq is false
{"bwnz",        FCBEMZ(1,2,0,2,0,0),   FCBEMZ_MASK,    PPE,    PPCNONE,        {RA, BDX}},
{"bwnzl",       FCBEMZ(1,2,0,2,0,1),   FCBEMZ_MASK,    PPE,    PPCNONE,        {RA, BDX}},


// PX=1, BIX=0: less than is true
{"cmpwiblt",    FCBEM(1,2,1,0,0),      FCBEM_MASK,     PPE,    PPCNONE,        {RA, UIX, BDX}},
{"cmpwibltl",   FCBEM(1,2,1,0,1),      FCBEM_MASK,     PPE,    PPCNONE,        {RA, UIX, BDX}},
// PX=0, BIX=1: not greater than is false (less than or eq)
{"cmpwible",    FCBEM(1,2,0,1,0),      FCBEM_MASK,     PPE,    PPCNONE,        {RA, UIX, BDX}},
{"cmpwiblel",   FCBEM(1,2,0,1,1),      FCBEM_MASK,     PPE,    PPCNONE,        {RA, UIX, BDX}},
// PX=1, BIX=1: greater than is True
{"cmpwibgt",    FCBEM(1,2,1,1,0),      FCBEM_MASK,     PPE,    PPCNONE,        {RA, UIX, BDX}},
{"cmpwibgtl",   FCBEM(1,2,1,1,1),      FCBEM_MASK,     PPE,    PPCNONE,        {RA, UIX, BDX}},
// PX=0, BIX=0: not less than is false (greater than or eq)
{"cmpwibge",    FCBEM(1,2,0,0,0),      FCBEM_MASK,     PPE,    PPCNONE,        {RA, UIX, BDX}},
{"cmpwibgel",   FCBEM(1,2,0,0,1),      FCBEM_MASK,     PPE,    PPCNONE,        {RA, UIX, BDX}},
// PX=1, BIX=2: eq is true
{"cmpwibeq",    FCBEM(1,2,1,2,0),      FCBEM_MASK,     PPE,    PPCNONE,        {RA, UIX, BDX}},
{"cmpwibeql",   FCBEM(1,2,1,2,1),      FCBEM_MASK,     PPE,    PPCNONE,        {RA, UIX, BDX}},
// PX=0, BIX=2: eq is false
{"cmpwibne",    FCBEM(1,2,0,2,0),      FCBEM_MASK,     PPE,    PPCNONE,        {RA, UIX, BDX}},
{"cmpwibnel",   FCBEM(1,2,0,2,1),      FCBEM_MASK,     PPE,    PPCNONE,        {RA, UIX, BDX}},



// PX=0, BIX=3: subtract and branch if eq = 0
{"subwibz",     FCBEM(1,2,1,3,0),      FCBEM_MASK,     PPE,    PPCNONE,        {RA, UIX, BDX}},
{"subwibzl",    FCBEM(1,2,1,3,1),      FCBEM_MASK,     PPE,    PPCNONE,        {RA, UIX, BDX}},
// PX=1, BIX=3: // PX=0, BIX=3: subtract and branch if eq = 1
{"subwibnz",    FCBEM(1,2,0,3,0),      FCBEM_MASK,     PPE,    PPCNONE,        {RA, UIX, BDX}},
{"subwibnzl",   FCBEM(1,2,0,3,1),      FCBEM_MASK,     PPE,    PPCNONE,        {RA, UIX, BDX}},

// PX=1, BIX=0
{"bb0wi",       FCBEM(1,3,1,0,0),   FCBEM_MASK,        PPE,    PPCNONE,        {RA, BNX, BDX}},
{"bb0wil",      FCBEM(1,3,1,0,1),   FCBEM_MASK,        PPE,    PPCNONE,        {RA, BNX, BDX}},
// PX=1, BIX=1
{"bb0w",        FCBEM(1,3,1,1,0),   FCBEM_MASK,        PPE,    PPCNONE,        {RA, RB, BDX}},
{"bb0wl",       FCBEM(1,3,1,1,1),   FCBEM_MASK,        PPE,    PPCNONE,        {RA, RB, BDX}},
// PX=0, BIX=0
{"bb1wi",       FCBEM(1,3,0,0,0),   FCBEM_MASK,        PPE,    PPCNONE,        {RA, BNX, BDX}},
{"bb1wil",      FCBEM(1,3,0,0,1),   FCBEM_MASK,        PPE,    PPCNONE,        {RA, BNX, BDX}},
// PX=0, BIX=1
{"bb1w",        FCBEM(1,3,0,1,0),   FCBEM_MASK,        PPE,    PPCNONE,        {RA, RB, BDX}},
{"bb1wl",       FCBEM(1,3,0,1,1),   FCBEM_MASK,        PPE,    PPCNONE,        {RA, RB, BDX}},


{"bbwi",        FB(1,3,0,0),   FB_MASK,        PPE,    PPCNONE,        {PXINV, RA, BNX, BDX}},
{"bbwil",       FB(1,3,0,1),   FB_MASK,        PPE,    PPCNONE,        {PXINV, RA, BNX, BDX}},

{"bbw",         FB(1,3,1,0),   FB_MASK,        PPE,    PPCNONE,        {PXINV, RA, RB, BDX}},
{"bbwl",        FB(1,3,1,1),   FB_MASK,        PPE,    PPCNONE,        {PXINV, RA, RB, BDX}},


{"bnbwi",       FB(1,3,0,0),   FB_MASK,        PPE,    PPCNONE,        {PX, RA, BNX, BDX}},
{"bnbwil",      FB(1,3,0,1),   FB_MASK,        PPE,    PPCNONE,        {PX, RA, BNX, BDX}},

{"bnbw",        FB(1,3,1,0),   FB_MASK,        PPE,    PPCNONE,        {PX, RA, RB, BDX}},
{"bnbwl",       FB(1,3,1,1),   FB_MASK,        PPE,    PPCNONE,        {PX, RA, RB, BDX}},

// subop = 3 PX=1, BIX=2:
{"clrbwibz",    FCBEM(1,3,1,2,0),      FCBEM_MASK,     PPE,    PPCNONE,        {RA, BNX, BDX}},
{"clrbwibzl",   FCBEM(1,3,1,2,1),      FCBEM_MASK,     PPE,    PPCNONE,        {RA, BNX, BDX}},
// subop = 3 PX=0, BIX=2:
{"clrbwibnz",   FCBEM(1,3,0,2,0),      FCBEM_MASK,     PPE,    PPCNONE,        {RA, BNX, BDX}},
{"clrbwibnzl",  FCBEM(1,3,0,2,1),      FCBEM_MASK,     PPE,    PPCNONE,        {RA, BNX, BDX}},

{"clrbwibc",    FB(1,3,2,0),   FB_MASK,        PPE,    PPCNONE,        {PX, RA, BNX, BDX}},
{"clrbwibcl",   FB(1,3,2,1),   FB_MASK,        PPE,    PPCNONE,        {PX, RA, BNX, BDX}},

// subop = 3 PX=1, BIX=3:
{"clrbwbz",     FCBEM(1,3,1,3,0),      FCBEM_MASK,     PPE,    PPCNONE,        {RA, RB, BDX}},
{"clrbwbzl",    FCBEM(1,3,1,3,1),      FCBEM_MASK,     PPE,    PPCNONE,        {RA, RB, BDX}},
// subop = 3 PX=0, BIX=3:
{"clrbwbnz",    FCBEM(1,3,0,3,0),      FCBEM_MASK,     PPE,    PPCNONE,        {RA, RB, BDX}},
{"clrbwbnzl",   FCBEM(1,3,0,3,1),      FCBEM_MASK,     PPE,    PPCNONE,        {RA, RB, BDX}},

{"clrbwbc",     FB(1,3,3,0),   FB_MASK,        PPE,    PPCNONE,        {PX, RA, RB, BDX}},
{"clrbwbcl",    FB(1,3,3,1),   FB_MASK,        PPE,    PPCNONE,        {PX, RA, RB, BDX}},

{"cmpwbc",      FCB(1,0,0),    FCB_MASK,       PPE,    PPCNONE,        {PX, BIX, RA, RB, BDX}},
{"cmpwbcl",     FCB(1,0,1),    FCB_MASK,       PPE,    PPCNONE,        {PX, BIX, RA, RB, BDX}},

{"cmplwbc",     FCB(1,1,0),    FCB_MASK,       PPE,    PPCNONE,        {PX, BIX, RA, RB, BDX}},
{"cmplwbcl",    FCB(1,1,1),    FCB_MASK,       PPE,    PPCNONE,        {PX, BIX, RA, RB, BDX}},

{"cmpwibc",     FCB(1,2,0),    FCB_MASK,       PPE,    PPCNONE,        {PX, BIX, RA, UIX, BDX}},
{"cmpwibcl",    FCB(1,2,1),    FCB_MASK,       PPE,    PPCNONE,        {PX, BIX, RA, UIX, BDX}},
...
{"mullhwu",	XRC(4, 392,0),	X_MASK,      PPE|MULHW|PPCVLE, PPCNONE,	{RT, RA, RB}},
{"evlwhex",	VX (4, 784),	VX_MASK,     PPCSPE|PPCVLE, PPCNONE,	{RS, RA, RB}},
{"mullhwu.",	XRC(4, 392,1),	X_MASK,      PPE|MULHW|PPCVLE, PPCNONE,	{RT, RA, RB}},
...
{"mullhw",	XRC(4, 424,0),	X_MASK,      PPE|MULHW|PPCVLE, PPCNONE,	{RT, RA, RB}},
{"mullhw.",	XRC(4, 424,1),	X_MASK,      PPE|MULHW|PPCVLE, PPCNONE,	{RT, RA, RB}},
...
{"lvd",		OP(5),		OP_MASK,     PPE,	PPCNONE,	{VDT, D, RA}},
{"stvd",	OP(6),		OP_MASK,     PPE,	PPCNONE,	{VDS, D, RA}},

{"mulli",	OP(7),		OP_MASK,     PPEX|PPCCOM,	PPCNONE,	{RT, RA, SI}},
{"muli",	OP(7),		OP_MASK,     PWRCOM,	PPCNONE,	{RT, RA, SI}},

{"subfic",	OP(8),		OP_MASK,     PPE|PPCCOM,	PPCNONE,	{RT, RA, SI}},
{"sfi",		OP(8),		OP_MASK,     PWRCOM,	PPCNONE,	{RT, RA, SI}},

{"lvdu",	OP(9),		OP_MASK,     PPE,	PPCNONE,	{VDT, D, RA}},
{"dozi",	OP(9),		OP_MASK,     M601,	PPCNONE,	{RT, RA, SI}},

{"cmplwi",	OPL(10,0),	OPL_MASK,    PPE|PPCCOM,	PPCNONE,	{OBF, RA, UI}},
{"cmpldi",	OPL(10,1),	OPL_MASK,    PPC64,	PPCNONE,	{OBF, RA, UI}},
{"cmpli",	OP(10),		OP_MASK,     PPE|PPC,	PPCNONE,	{BF, L, RA, UI}},
{"cmpli",	OP(10),		OP_MASK,     PWRCOM,	PPC,		{BF, RA, UI}},

{"cmpwi",	OPL(11,0),	OPL_MASK,    PPE|PPCCOM,	PPCNONE,	{OBF, RA, SI}},
{"cmpdi",	OPL(11,1),	OPL_MASK,    PPC64,	PPCNONE,	{OBF, RA, SI}},
{"cmpi",	OP(11),		OP_MASK,     PPE|PPC,	PPCNONE,	{BF, L, RA, SI}},
{"cmpi",	OP(11),		OP_MASK,     PWRCOM,	PPC,		{BF, RA, SI}},

{"addic",	OP(12),		OP_MASK,     PPE|PPCCOM,	PPCNONE,	{RT, RA, SI}},
{"ai",		OP(12),		OP_MASK,     PWRCOM,	PPCNONE,	{RT, RA, SI}},
{"subic",	OP(12),		OP_MASK,     PPE|PPCCOM,	PPCNONE,	{RT, RA, NSI}},

{"addic.",	OP(13),		OP_MASK,     PPE|PPCCOM,	PPCNONE,	{RT, RA, SI}},
{"ai.",		OP(13),		OP_MASK,     PWRCOM,	PPCNONE,	{RT, RA, SI}},
{"subic.",	OP(13),		OP_MASK,     PPCCOM,	PPCNONE,	{RT, RA, NSI}},

{"li",		OP(14),		DRA_MASK,    PPE|PPCCOM,	PPCNONE,	{RT, SI}},
{"lil",		OP(14),		DRA_MASK,    PWRCOM,	PPCNONE,	{RT, SI}},
{"addi",	OP(14),		OP_MASK,     PPE|PPCCOM,	PPCNONE,	{RT, RA0, SI}},
{"cal",		OP(14),		OP_MASK,     PWRCOM,	PPCNONE,	{RT, D, RA0}},
{"subi",	OP(14),		OP_MASK,     PPE|PPCCOM,	PPCNONE,	{RT, RA0, NSI}},
{"la",		OP(14),		OP_MASK,     PPE|PPCCOM,	PPCNONE,	{RT, D, RA0}},

{"lis",		OP(15),		DRA_MASK,    PPE|PPCCOM,	PPCNONE,	{RT, SISIGNOPT}},
{"liu",		OP(15),		DRA_MASK,    PWRCOM,	PPCNONE,	{RT, SISIGNOPT}},
{"addis",	OP(15),		OP_MASK,     PPE|PPCCOM,	PPCNONE,	{RT, RA0, SISIGNOPT}},
{"cau",		OP(15),		OP_MASK,     PWRCOM,	PPCNONE,	{RT, RA0, SISIGNOPT}},
{"subis",	OP(15),		OP_MASK,     PPE|PPCCOM,	PPCNONE,	{RT, RA0, NSI}},

{"bdnz-",    BBO(16,BODNZ,0,0),		BBOATBI_MASK,  PPE|PPCCOM,	 PPCNONE,	{BDM}},
{"bdnz+",    BBO(16,BODNZ,0,0),		BBOATBI_MASK,  PPE|PPCCOM,	 PPCNONE,	{BDP}},
{"bdnz",     BBO(16,BODNZ,0,0),		BBOATBI_MASK,  PPE|PPCCOM,	 PPCNONE,	{BD}},
{"bdn",      BBO(16,BODNZ,0,0),		BBOATBI_MASK,  PWRCOM,	 PPCNONE,	{BD}},
{"bdnzl-",   BBO(16,BODNZ,0,1),		BBOATBI_MASK,  PPE|PPCCOM,	 PPCNONE,	{BDM}},
{"bdnzl+",   BBO(16,BODNZ,0,1),		BBOATBI_MASK,  PPE|PPCCOM,	 PPCNONE,	{BDP}},
{"bdnzl",    BBO(16,BODNZ,0,1),		BBOATBI_MASK,  PPE|PPCCOM,	 PPCNONE,	{BD}},
{"bdnl",     BBO(16,BODNZ,0,1),		BBOATBI_MASK,  PWRCOM,	 PPCNONE,	{BD}},
{"bdnza-",   BBO(16,BODNZ,1,0),		BBOATBI_MASK,  PPE|PPCCOM,	 PPCNONE,	{BDMA}},
{"bdnza+",   BBO(16,BODNZ,1,0),		BBOATBI_MASK,  PPE|PPCCOM,	 PPCNONE,	{BDPA}},
{"bdnza",    BBO(16,BODNZ,1,0),		BBOATBI_MASK,  PPE|PPCCOM,	 PPCNONE,	{BDA}},
{"bdna",     BBO(16,BODNZ,1,0),		BBOATBI_MASK,  PWRCOM,	 PPCNONE,	{BDA}},
{"bdnzla-",  BBO(16,BODNZ,1,1),		BBOATBI_MASK,  PPE|PPCCOM,	 PPCNONE,	{BDMA}},
{"bdnzla+",  BBO(16,BODNZ,1,1),		BBOATBI_MASK,  PPE|PPCCOM,	 PPCNONE,	{BDPA}},
{"bdnzla",   BBO(16,BODNZ,1,1),		BBOATBI_MASK,  PPE|PPCCOM,	 PPCNONE,	{BDA}},
{"bdnla",    BBO(16,BODNZ,1,1),		BBOATBI_MASK,  PWRCOM,	 PPCNONE,	{BDA}},
{"bdz-",     BBO(16,BODZ,0,0),		BBOATBI_MASK,  PPE|PPCCOM,	 PPCNONE,	{BDM}},
{"bdz+",     BBO(16,BODZ,0,0),		BBOATBI_MASK,  PPE|PPCCOM,	 PPCNONE,	{BDP}},
{"bdz",      BBO(16,BODZ,0,0),		BBOATBI_MASK,  PPE|COM,	 PPCNONE,	{BD}},
{"bdzl-",    BBO(16,BODZ,0,1),		BBOATBI_MASK,  PPE|PPCCOM,	 PPCNONE,	{BDM}},
{"bdzl+",    BBO(16,BODZ,0,1),		BBOATBI_MASK,  PPE|PPCCOM,	 PPCNONE,	{BDP}},
{"bdzl",     BBO(16,BODZ,0,1),		BBOATBI_MASK,  PPE|COM,	 PPCNONE,	{BD}},
{"bdza-",    BBO(16,BODZ,1,0),		BBOATBI_MASK,  PPE|PPCCOM,	 PPCNONE,	{BDMA}},
{"bdza+",    BBO(16,BODZ,1,0),		BBOATBI_MASK,  PPE|PPCCOM,	 PPCNONE,	{BDPA}},
{"bdza",     BBO(16,BODZ,1,0),		BBOATBI_MASK,  PPE|COM,	 PPCNONE,	{BDA}},
{"bdzla-",   BBO(16,BODZ,1,1),		BBOATBI_MASK,  PPE|PPCCOM,	 PPCNONE,	{BDMA}},
{"bdzla+",   BBO(16,BODZ,1,1),		BBOATBI_MASK,  PPE|PPCCOM,	 PPCNONE,	{BDPA}},
{"bdzla",    BBO(16,BODZ,1,1),		BBOATBI_MASK,  PPE|COM,	 PPCNONE,	{BDA}},

{"bge-",     BBOCB(16,BOF,CBLT,0,0),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDM}},
{"bge+",     BBOCB(16,BOF,CBLT,0,0),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDP}},
{"bge",      BBOCB(16,BOF,CBLT,0,0),	BBOATCB_MASK,  PPE|COM,	 PPCNONE,	{CR, BD}},
{"bnl-",     BBOCB(16,BOF,CBLT,0,0),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDM}},
{"bnl+",     BBOCB(16,BOF,CBLT,0,0),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDP}},
{"bnl",      BBOCB(16,BOF,CBLT,0,0),	BBOATCB_MASK,  PPE|COM,	 PPCNONE,	{CR, BD}},
{"bgel-",    BBOCB(16,BOF,CBLT,0,1),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDM}},
{"bgel+",    BBOCB(16,BOF,CBLT,0,1),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDP}},
{"bgel",     BBOCB(16,BOF,CBLT,0,1),	BBOATCB_MASK,  PPE|COM,	 PPCNONE,	{CR, BD}},
{"bnll-",    BBOCB(16,BOF,CBLT,0,1),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDM}},
{"bnll+",    BBOCB(16,BOF,CBLT,0,1),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDP}},
{"bnll",     BBOCB(16,BOF,CBLT,0,1),	BBOATCB_MASK,  PPE|COM,	 PPCNONE,	{CR, BD}},
{"bgea-",    BBOCB(16,BOF,CBLT,1,0),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDMA}},
{"bgea+",    BBOCB(16,BOF,CBLT,1,0),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDPA}},
{"bgea",     BBOCB(16,BOF,CBLT,1,0),	BBOATCB_MASK,  PPE|COM,	 PPCNONE,	{CR, BDA}},
{"bnla-",    BBOCB(16,BOF,CBLT,1,0),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDMA}},
{"bnla+",    BBOCB(16,BOF,CBLT,1,0),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDPA}},
{"bnla",     BBOCB(16,BOF,CBLT,1,0),	BBOATCB_MASK,  PPE|COM,	 PPCNONE,	{CR, BDA}},
{"bgela-",   BBOCB(16,BOF,CBLT,1,1),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDMA}},
{"bgela+",   BBOCB(16,BOF,CBLT,1,1),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDPA}},
{"bgela",    BBOCB(16,BOF,CBLT,1,1),	BBOATCB_MASK,  PPE|COM,	 PPCNONE,	{CR, BDA}},
{"bnlla-",   BBOCB(16,BOF,CBLT,1,1),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDMA}},
{"bnlla+",   BBOCB(16,BOF,CBLT,1,1),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDPA}},
{"bnlla",    BBOCB(16,BOF,CBLT,1,1),	BBOATCB_MASK,  PPE|COM,	 PPCNONE,	{CR, BDA}},
{"ble-",     BBOCB(16,BOF,CBGT,0,0),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDM}},
{"ble+",     BBOCB(16,BOF,CBGT,0,0),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDP}},
{"ble",      BBOCB(16,BOF,CBGT,0,0),	BBOATCB_MASK,  PPE|COM,	 PPCNONE,	{CR, BD}},
{"bng-",     BBOCB(16,BOF,CBGT,0,0),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDM}},
{"bng+",     BBOCB(16,BOF,CBGT,0,0),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDP}},
{"bng",      BBOCB(16,BOF,CBGT,0,0),	BBOATCB_MASK,  PPE|COM,	 PPCNONE,	{CR, BD}},
{"blel-",    BBOCB(16,BOF,CBGT,0,1),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDM}},
{"blel+",    BBOCB(16,BOF,CBGT,0,1),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDP}},
{"blel",     BBOCB(16,BOF,CBGT,0,1),	BBOATCB_MASK,  PPE|COM,	 PPCNONE,	{CR, BD}},
{"bngl-",    BBOCB(16,BOF,CBGT,0,1),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDM}},
{"bngl+",    BBOCB(16,BOF,CBGT,0,1),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDP}},
{"bngl",     BBOCB(16,BOF,CBGT,0,1),	BBOATCB_MASK,  PPE|COM,	 PPCNONE,	{CR, BD}},
{"blea-",    BBOCB(16,BOF,CBGT,1,0),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDMA}},
{"blea+",    BBOCB(16,BOF,CBGT,1,0),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDPA}},
{"blea",     BBOCB(16,BOF,CBGT,1,0),	BBOATCB_MASK,  PPE|COM,	 PPCNONE,	{CR, BDA}},
{"bnga-",    BBOCB(16,BOF,CBGT,1,0),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDMA}},
{"bnga+",    BBOCB(16,BOF,CBGT,1,0),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDPA}},
{"bnga",     BBOCB(16,BOF,CBGT,1,0),	BBOATCB_MASK,  PPE|COM,	 PPCNONE,	{CR, BDA}},
{"blela-",   BBOCB(16,BOF,CBGT,1,1),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDMA}},
{"blela+",   BBOCB(16,BOF,CBGT,1,1),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDPA}},
{"blela",    BBOCB(16,BOF,CBGT,1,1),	BBOATCB_MASK,  PPE|COM,	 PPCNONE,	{CR, BDA}},
{"bngla-",   BBOCB(16,BOF,CBGT,1,1),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDMA}},
{"bngla+",   BBOCB(16,BOF,CBGT,1,1),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDPA}},
{"bngla",    BBOCB(16,BOF,CBGT,1,1),	BBOATCB_MASK,  PPE|COM,	 PPCNONE,	{CR, BDA}},
{"bne-",     BBOCB(16,BOF,CBEQ,0,0),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDM}},
{"bne+",     BBOCB(16,BOF,CBEQ,0,0),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDP}},
{"bne",      BBOCB(16,BOF,CBEQ,0,0),	BBOATCB_MASK,  PPE|COM,	 PPCNONE,	{CR, BD}},
{"bnel-",    BBOCB(16,BOF,CBEQ,0,1),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDM}},
{"bnel+",    BBOCB(16,BOF,CBEQ,0,1),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDP}},
{"bnel",     BBOCB(16,BOF,CBEQ,0,1),	BBOATCB_MASK,  PPE|COM,	 PPCNONE,	{CR, BD}},
{"bnea-",    BBOCB(16,BOF,CBEQ,1,0),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDMA}},
{"bnea+",    BBOCB(16,BOF,CBEQ,1,0),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDPA}},
{"bnea",     BBOCB(16,BOF,CBEQ,1,0),	BBOATCB_MASK,  PPE|COM,	 PPCNONE,	{CR, BDA}},
{"bnela-",   BBOCB(16,BOF,CBEQ,1,1),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDMA}},
{"bnela+",   BBOCB(16,BOF,CBEQ,1,1),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDPA}},
{"bnela",    BBOCB(16,BOF,CBEQ,1,1),	BBOATCB_MASK,  PPE|COM,	 PPCNONE,	{CR, BDA}},
{"bns-",     BBOCB(16,BOF,CBSO,0,0),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDM}},
{"bns+",     BBOCB(16,BOF,CBSO,0,0),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDP}},
{"bns",      BBOCB(16,BOF,CBSO,0,0),	BBOATCB_MASK,  PPE|COM,	 PPCNONE,	{CR, BD}},
{"bnu-",     BBOCB(16,BOF,CBSO,0,0),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDM}},
{"bnu+",     BBOCB(16,BOF,CBSO,0,0),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDP}},
{"bnu",      BBOCB(16,BOF,CBSO,0,0),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BD}},
{"bnsl-",    BBOCB(16,BOF,CBSO,0,1),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDM}},
{"bnsl+",    BBOCB(16,BOF,CBSO,0,1),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDP}},
{"bnsl",     BBOCB(16,BOF,CBSO,0,1),	BBOATCB_MASK,  PPE|COM,	 PPCNONE,	{CR, BD}},
{"bnul-",    BBOCB(16,BOF,CBSO,0,1),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDM}},
{"bnul+",    BBOCB(16,BOF,CBSO,0,1),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDP}},
{"bnul",     BBOCB(16,BOF,CBSO,0,1),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BD}},
{"bnsa-",    BBOCB(16,BOF,CBSO,1,0),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDMA}},
{"bnsa+",    BBOCB(16,BOF,CBSO,1,0),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDPA}},
{"bnsa",     BBOCB(16,BOF,CBSO,1,0),	BBOATCB_MASK,  PPE|COM,	 PPCNONE,	{CR, BDA}},
{"bnua-",    BBOCB(16,BOF,CBSO,1,0),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDMA}},
{"bnua+",    BBOCB(16,BOF,CBSO,1,0),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDPA}},
{"bnua",     BBOCB(16,BOF,CBSO,1,0),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDA}},
{"bnsla-",   BBOCB(16,BOF,CBSO,1,1),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDMA}},
{"bnsla+",   BBOCB(16,BOF,CBSO,1,1),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDPA}},
{"bnsla",    BBOCB(16,BOF,CBSO,1,1),	BBOATCB_MASK,  PPE|COM,	 PPCNONE,	{CR, BDA}},
{"bnula-",   BBOCB(16,BOF,CBSO,1,1),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDMA}},
{"bnula+",   BBOCB(16,BOF,CBSO,1,1),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDPA}},
{"bnula",    BBOCB(16,BOF,CBSO,1,1),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDA}},

{"blt-",     BBOCB(16,BOT,CBLT,0,0),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDM}},
{"blt+",     BBOCB(16,BOT,CBLT,0,0),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDP}},
{"blt",      BBOCB(16,BOT,CBLT,0,0),	BBOATCB_MASK,  PPE|COM,	 PPCNONE,	{CR, BD}},
{"bltl-",    BBOCB(16,BOT,CBLT,0,1),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDM}},
{"bltl+",    BBOCB(16,BOT,CBLT,0,1),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDP}},
{"bltl",     BBOCB(16,BOT,CBLT,0,1),	BBOATCB_MASK,  PPE|COM,	 PPCNONE,	{CR, BD}},
{"blta-",    BBOCB(16,BOT,CBLT,1,0),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDMA}},
{"blta+",    BBOCB(16,BOT,CBLT,1,0),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDPA}},
{"blta",     BBOCB(16,BOT,CBLT,1,0),	BBOATCB_MASK,  PPE|COM,	 PPCNONE,	{CR, BDA}},
{"bltla-",   BBOCB(16,BOT,CBLT,1,1),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDMA}},
{"bltla+",   BBOCB(16,BOT,CBLT,1,1),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDPA}},
{"bltla",    BBOCB(16,BOT,CBLT,1,1),	BBOATCB_MASK,  PPE|COM,	 PPCNONE,	{CR, BDA}},
{"bgt-",     BBOCB(16,BOT,CBGT,0,0),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDM}},
{"bgt+",     BBOCB(16,BOT,CBGT,0,0),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDP}},
{"bgt",      BBOCB(16,BOT,CBGT,0,0),	BBOATCB_MASK,  PPE|COM,	 PPCNONE,	{CR, BD}},
{"bgtl-",    BBOCB(16,BOT,CBGT,0,1),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDM}},
{"bgtl+",    BBOCB(16,BOT,CBGT,0,1),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDP}},
{"bgtl",     BBOCB(16,BOT,CBGT,0,1),	BBOATCB_MASK,  PPE|COM,	 PPCNONE,	{CR, BD}},
{"bgta-",    BBOCB(16,BOT,CBGT,1,0),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDMA}},
{"bgta+",    BBOCB(16,BOT,CBGT,1,0),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDPA}},
{"bgta",     BBOCB(16,BOT,CBGT,1,0),	BBOATCB_MASK,  PPE|COM,	 PPCNONE,	{CR, BDA}},
{"bgtla-",   BBOCB(16,BOT,CBGT,1,1),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDMA}},
{"bgtla+",   BBOCB(16,BOT,CBGT,1,1),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDPA}},
{"bgtla",    BBOCB(16,BOT,CBGT,1,1),	BBOATCB_MASK,  PPE|COM,	 PPCNONE,	{CR, BDA}},
{"beq-",     BBOCB(16,BOT,CBEQ,0,0),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDM}},
{"beq+",     BBOCB(16,BOT,CBEQ,0,0),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDP}},
{"beq",      BBOCB(16,BOT,CBEQ,0,0),	BBOATCB_MASK,  PPE|COM,	 PPCNONE,	{CR, BD}},
{"beql-",    BBOCB(16,BOT,CBEQ,0,1),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDM}},
{"beql+",    BBOCB(16,BOT,CBEQ,0,1),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDP}},
{"beql",     BBOCB(16,BOT,CBEQ,0,1),	BBOATCB_MASK,  PPE|COM,	 PPCNONE,	{CR, BD}},
{"beqa-",    BBOCB(16,BOT,CBEQ,1,0),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDMA}},
{"beqa+",    BBOCB(16,BOT,CBEQ,1,0),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDPA}},
{"beqa",     BBOCB(16,BOT,CBEQ,1,0),	BBOATCB_MASK,  PPE|COM,	 PPCNONE,	{CR, BDA}},
{"beqla-",   BBOCB(16,BOT,CBEQ,1,1),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDMA}},
{"beqla+",   BBOCB(16,BOT,CBEQ,1,1),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDPA}},
{"beqla",    BBOCB(16,BOT,CBEQ,1,1),	BBOATCB_MASK,  PPE|COM,	 PPCNONE,	{CR, BDA}},
{"bso-",     BBOCB(16,BOT,CBSO,0,0),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDM}},
{"bso+",     BBOCB(16,BOT,CBSO,0,0),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDP}},
{"bso",      BBOCB(16,BOT,CBSO,0,0),	BBOATCB_MASK,  PPE|COM,	 PPCNONE,	{CR, BD}},
{"bun-",     BBOCB(16,BOT,CBSO,0,0),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDM}},
{"bun+",     BBOCB(16,BOT,CBSO,0,0),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDP}},
{"bun",      BBOCB(16,BOT,CBSO,0,0),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BD}},
{"bsol-",    BBOCB(16,BOT,CBSO,0,1),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDM}},
{"bsol+",    BBOCB(16,BOT,CBSO,0,1),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDP}},
{"bsol",     BBOCB(16,BOT,CBSO,0,1),	BBOATCB_MASK,  PPE|COM,	 PPCNONE,	{CR, BD}},
{"bunl-",    BBOCB(16,BOT,CBSO,0,1),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDM}},
{"bunl+",    BBOCB(16,BOT,CBSO,0,1),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDP}},
{"bunl",     BBOCB(16,BOT,CBSO,0,1),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BD}},
{"bsoa-",    BBOCB(16,BOT,CBSO,1,0),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDMA}},
{"bsoa+",    BBOCB(16,BOT,CBSO,1,0),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDPA}},
{"bsoa",     BBOCB(16,BOT,CBSO,1,0),	BBOATCB_MASK,  PPE|COM,	 PPCNONE,	{CR, BDA}},
{"buna-",    BBOCB(16,BOT,CBSO,1,0),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDMA}},
{"buna+",    BBOCB(16,BOT,CBSO,1,0),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDPA}},
{"buna",     BBOCB(16,BOT,CBSO,1,0),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDA}},
{"bsola-",   BBOCB(16,BOT,CBSO,1,1),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDMA}},
{"bsola+",   BBOCB(16,BOT,CBSO,1,1),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDPA}},
{"bsola",    BBOCB(16,BOT,CBSO,1,1),	BBOATCB_MASK,  PPE|COM,	 PPCNONE,	{CR, BDA}},
{"bunla-",   BBOCB(16,BOT,CBSO,1,1),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDMA}},
{"bunla+",   BBOCB(16,BOT,CBSO,1,1),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDPA}},
{"bunla",    BBOCB(16,BOT,CBSO,1,1),	BBOATCB_MASK,  PPE|PPCCOM,	 PPCNONE,	{CR, BDA}},

{"bdnzf-",   BBO(16,BODNZF,0,0),	BBOY_MASK,     PPE|PPCCOM,   ISA_V2,	{BI, BDM}},
{"bdnzf+",   BBO(16,BODNZF,0,0),	BBOY_MASK,     PPE|PPCCOM,   ISA_V2,	{BI, BDP}},
{"bdnzf",    BBO(16,BODNZF,0,0),	BBOY_MASK,     PPE|PPCCOM,	 PPCNONE,	{BI, BD}},
{"bdnzfl-",  BBO(16,BODNZF,0,1),	BBOY_MASK,     PPE|PPCCOM,   ISA_V2,	{BI, BDM}},
{"bdnzfl+",  BBO(16,BODNZF,0,1),	BBOY_MASK,     PPE|PPCCOM,   ISA_V2,	{BI, BDP}},
{"bdnzfl",   BBO(16,BODNZF,0,1),	BBOY_MASK,     PPE|PPCCOM,	 PPCNONE,	{BI, BD}},
{"bdnzfa-",  BBO(16,BODNZF,1,0),	BBOY_MASK,     PPE|PPCCOM,   ISA_V2,	{BI, BDMA}},
{"bdnzfa+",  BBO(16,BODNZF,1,0),	BBOY_MASK,     PPE|PPCCOM,   ISA_V2,	{BI, BDPA}},
{"bdnzfa",   BBO(16,BODNZF,1,0),	BBOY_MASK,     PPE|PPCCOM,	 PPCNONE,	{BI, BDA}},
{"bdnzfla-", BBO(16,BODNZF,1,1),	BBOY_MASK,     PPE|PPCCOM,   ISA_V2,	{BI, BDMA}},
{"bdnzfla+", BBO(16,BODNZF,1,1),	BBOY_MASK,     PPE|PPCCOM,   ISA_V2,	{BI, BDPA}},
{"bdnzfla",  BBO(16,BODNZF,1,1),	BBOY_MASK,     PPE|PPCCOM,	 PPCNONE,	{BI, BDA}},
{"bdzf-",    BBO(16,BODZF,0,0),		BBOY_MASK,     PPE|PPCCOM,   ISA_V2,	{BI, BDM}},
{"bdzf+",    BBO(16,BODZF,0,0),		BBOY_MASK,     PPE|PPCCOM,   ISA_V2,	{BI, BDP}},
{"bdzf",     BBO(16,BODZF,0,0),		BBOY_MASK,     PPE|PPCCOM,	 PPCNONE,	{BI, BD}},
{"bdzfl-",   BBO(16,BODZF,0,1),		BBOY_MASK,     PPE|PPCCOM,   ISA_V2,	{BI, BDM}},
{"bdzfl+",   BBO(16,BODZF,0,1),		BBOY_MASK,     PPE|PPCCOM,   ISA_V2,	{BI, BDP}},
{"bdzfl",    BBO(16,BODZF,0,1),		BBOY_MASK,     PPE|PPCCOM,	 PPCNONE,	{BI, BD}},
{"bdzfa-",   BBO(16,BODZF,1,0),		BBOY_MASK,     PPE|PPCCOM,   ISA_V2,	{BI, BDMA}},
{"bdzfa+",   BBO(16,BODZF,1,0),		BBOY_MASK,     PPE|PPCCOM,   ISA_V2,	{BI, BDPA}},
{"bdzfa",    BBO(16,BODZF,1,0),		BBOY_MASK,     PPE|PPCCOM,	 PPCNONE,	{BI, BDA}},
{"bdzfla-",  BBO(16,BODZF,1,1),		BBOY_MASK,     PPE|PPCCOM,   ISA_V2,	{BI, BDMA}},
{"bdzfla+",  BBO(16,BODZF,1,1),		BBOY_MASK,     PPE|PPCCOM,   ISA_V2,	{BI, BDPA}},
{"bdzfla",   BBO(16,BODZF,1,1),		BBOY_MASK,     PPE|PPCCOM,	 PPCNONE,	{BI, BDA}},

{"bf-",      BBO(16,BOF,0,0),		BBOAT_MASK,    PPE|PPCCOM,	 PPCNONE,	{BI, BDM}},
{"bf+",      BBO(16,BOF,0,0),		BBOAT_MASK,    PPE|PPCCOM,	 PPCNONE,	{BI, BDP}},
{"bf",	     BBO(16,BOF,0,0),		BBOAT_MASK,    PPE|PPCCOM,	 PPCNONE,	{BI, BD}},
{"bbf",      BBO(16,BOF,0,0),		BBOAT_MASK,    PWRCOM,	 PPCNONE,	{BI, BD}},
{"bfl-",     BBO(16,BOF,0,1),		BBOAT_MASK,    PPE|PPCCOM,	 PPCNONE,	{BI, BDM}},
{"bfl+",     BBO(16,BOF,0,1),		BBOAT_MASK,    PPE|PPCCOM,	 PPCNONE,	{BI, BDP}},
{"bfl",      BBO(16,BOF,0,1),		BBOAT_MASK,    PPE|PPCCOM,	 PPCNONE,	{BI, BD}},
{"bbfl",     BBO(16,BOF,0,1),		BBOAT_MASK,    PWRCOM,	 PPCNONE,	{BI, BD}},
{"bfa-",     BBO(16,BOF,1,0),		BBOAT_MASK,    PPE|PPCCOM,	 PPCNONE,	{BI, BDMA}},
{"bfa+",     BBO(16,BOF,1,0),		BBOAT_MASK,    PPE|PPCCOM,	 PPCNONE,	{BI, BDPA}},
{"bfa",      BBO(16,BOF,1,0),		BBOAT_MASK,    PPE|PPCCOM,	 PPCNONE,	{BI, BDA}},
{"bbfa",     BBO(16,BOF,1,0),		BBOAT_MASK,    PWRCOM,	 PPCNONE,	{BI, BDA}},
{"bfla-",    BBO(16,BOF,1,1),		BBOAT_MASK,    PPE|PPCCOM,	 PPCNONE,	{BI, BDMA}},
{"bfla+",    BBO(16,BOF,1,1),		BBOAT_MASK,    PPE|PPCCOM,	 PPCNONE,	{BI, BDPA}},
{"bfla",     BBO(16,BOF,1,1),		BBOAT_MASK,    PPE|PPCCOM,	 PPCNONE,	{BI, BDA}},
{"bbfla",    BBO(16,BOF,1,1),		BBOAT_MASK,    PWRCOM,	 PPCNONE,	{BI, BDA}},

{"bdnzt-",   BBO(16,BODNZT,0,0),	BBOY_MASK,     PPE|PPCCOM,   ISA_V2,	{BI, BDM}},
{"bdnzt+",   BBO(16,BODNZT,0,0),	BBOY_MASK,     PPE|PPCCOM,   ISA_V2,	{BI, BDP}},
{"bdnzt",    BBO(16,BODNZT,0,0),	BBOY_MASK,     PPE|PPCCOM,	 PPCNONE,	{BI, BD}},
{"bdnztl-",  BBO(16,BODNZT,0,1),	BBOY_MASK,     PPE|PPCCOM,   ISA_V2,	{BI, BDM}},
{"bdnztl+",  BBO(16,BODNZT,0,1),	BBOY_MASK,     PPE|PPCCOM,   ISA_V2,	{BI, BDP}},
{"bdnztl",   BBO(16,BODNZT,0,1),	BBOY_MASK,     PPE|PPCCOM,	 PPCNONE,	{BI, BD}},
{"bdnzta-",  BBO(16,BODNZT,1,0),	BBOY_MASK,     PPE|PPCCOM,   ISA_V2,	{BI, BDMA}},
{"bdnzta+",  BBO(16,BODNZT,1,0),	BBOY_MASK,     PPE|PPCCOM,   ISA_V2,	{BI, BDPA}},
{"bdnzta",   BBO(16,BODNZT,1,0),	BBOY_MASK,     PPE|PPCCOM,	 PPCNONE,	{BI, BDA}},
{"bdnztla-", BBO(16,BODNZT,1,1),	BBOY_MASK,     PPE|PPCCOM,   ISA_V2,	{BI, BDMA}},
{"bdnztla+", BBO(16,BODNZT,1,1),	BBOY_MASK,     PPE|PPCCOM,   ISA_V2,	{BI, BDPA}},
{"bdnztla",  BBO(16,BODNZT,1,1),	BBOY_MASK,     PPE|PPCCOM,	 PPCNONE,	{BI, BDA}},
{"bdzt-",    BBO(16,BODZT,0,0),		BBOY_MASK,     PPE|PPCCOM,   ISA_V2,	{BI, BDM}},
{"bdzt+",    BBO(16,BODZT,0,0),		BBOY_MASK,     PPE|PPCCOM,   ISA_V2,	{BI, BDP}},
{"bdzt",     BBO(16,BODZT,0,0),		BBOY_MASK,     PPE|PPCCOM,	 PPCNONE,	{BI, BD}},
{"bdztl-",   BBO(16,BODZT,0,1),		BBOY_MASK,     PPE|PPCCOM,   ISA_V2,	{BI, BDM}},
{"bdztl+",   BBO(16,BODZT,0,1),		BBOY_MASK,     PPE|PPCCOM,   ISA_V2,	{BI, BDP}},
{"bdztl",    BBO(16,BODZT,0,1),		BBOY_MASK,     PPE|PPCCOM,	 PPCNONE,	{BI, BD}},
{"bdzta-",   BBO(16,BODZT,1,0),		BBOY_MASK,     PPE|PPCCOM,   ISA_V2,	{BI, BDMA}},
{"bdzta+",   BBO(16,BODZT,1,0),		BBOY_MASK,     PPE|PPCCOM,   ISA_V2,	{BI, BDPA}},
{"bdzta",    BBO(16,BODZT,1,0),		BBOY_MASK,     PPE|PPCCOM,	 PPCNONE,	{BI, BDA}},
{"bdztla-",  BBO(16,BODZT,1,1),		BBOY_MASK,     PPE|PPCCOM,   ISA_V2,	{BI, BDMA}},
{"bdztla+",  BBO(16,BODZT,1,1),		BBOY_MASK,     PPE|PPCCOM,   ISA_V2,	{BI, BDPA}},
{"bdztla",   BBO(16,BODZT,1,1),		BBOY_MASK,     PPE|PPCCOM,	 PPCNONE,	{BI, BDA}},

{"bt-",      BBO(16,BOT,0,0),		BBOAT_MASK,    PPE|PPCCOM,	 PPCNONE,	{BI, BDM}},
{"bt+",      BBO(16,BOT,0,0),		BBOAT_MASK,    PPE|PPCCOM,	 PPCNONE,	{BI, BDP}},
{"bt",	     BBO(16,BOT,0,0),		BBOAT_MASK,    PPE|PPCCOM,	 PPCNONE,	{BI, BD}},
{"bbt",      BBO(16,BOT,0,0),		BBOAT_MASK,    PWRCOM,	 PPCNONE,	{BI, BD}},
{"btl-",     BBO(16,BOT,0,1),		BBOAT_MASK,    PPE|PPCCOM,	 PPCNONE,	{BI, BDM}},
{"btl+",     BBO(16,BOT,0,1),		BBOAT_MASK,    PPE|PPCCOM,	 PPCNONE,	{BI, BDP}},
{"btl",      BBO(16,BOT,0,1),		BBOAT_MASK,    PPE|PPCCOM,	 PPCNONE,	{BI, BD}},
{"bbtl",     BBO(16,BOT,0,1),		BBOAT_MASK,    PWRCOM,	 PPCNONE,	{BI, BD}},
{"bta-",     BBO(16,BOT,1,0),		BBOAT_MASK,    PPE|PPCCOM,	 PPCNONE,	{BI, BDMA}},
{"bta+",     BBO(16,BOT,1,0),		BBOAT_MASK,    PPE|PPCCOM,	 PPCNONE,	{BI, BDPA}},
{"bta",      BBO(16,BOT,1,0),		BBOAT_MASK,    PPE|PPCCOM,	 PPCNONE,	{BI, BDA}},
{"bbta",     BBO(16,BOT,1,0),		BBOAT_MASK,    PWRCOM,	 PPCNONE,	{BI, BDA}},
{"btla-",    BBO(16,BOT,1,1),		BBOAT_MASK,    PPE|PPCCOM,	 PPCNONE,	{BI, BDMA}},
{"btla+",    BBO(16,BOT,1,1),		BBOAT_MASK,    PPE|PPCCOM,	 PPCNONE,	{BI, BDPA}},
{"btla",     BBO(16,BOT,1,1),		BBOAT_MASK,    PPE|PPCCOM,	 PPCNONE,	{BI, BDA}},
{"bbtla",    BBO(16,BOT,1,1),		BBOAT_MASK,    PWRCOM,	 PPCNONE,	{BI, BDA}},

{"bc-",		B(16,0,0),	B_MASK,      PPE|PPCCOM,	PPCNONE,	{BOE, BI, BDM}},
{"bc+",		B(16,0,0),	B_MASK,      PPE|PPCCOM,	PPCNONE,	{BOE, BI, BDP}},
{"bc",		B(16,0,0),	B_MASK,      PPE|COM,	PPCNONE,	{BO, BI, BD}},
{"bcl-",	B(16,0,1),	B_MASK,      PPE|PPCCOM,	PPCNONE,	{BOE, BI, BDM}},
{"bcl+",	B(16,0,1),	B_MASK,      PPE|PPCCOM,	PPCNONE,	{BOE, BI, BDP}},
{"bcl",		B(16,0,1),	B_MASK,      PPE|COM,	PPCNONE,	{BO, BI, BD}},
{"bca-",	B(16,1,0),	B_MASK,      PPE|PPCCOM,	PPCNONE,	{BOE, BI, BDMA}},
{"bca+",	B(16,1,0),	B_MASK,      PPE|PPCCOM,	PPCNONE,	{BOE, BI, BDPA}},
{"bca",		B(16,1,0),	B_MASK,      PPE|COM,	PPCNONE,	{BO, BI, BDA}},
{"bcla-",	B(16,1,1),	B_MASK,      PPE|PPCCOM,	PPCNONE,	{BOE, BI, BDMA}},
{"bcla+",	B(16,1,1),	B_MASK,      PPE|PPCCOM,	PPCNONE,	{BOE, BI, BDPA}},
{"bcla",	B(16,1,1),	B_MASK,      PPE|COM,	PPCNONE,	{BO, BI, BDA}},
...
{"b",		B(18,0,0),	B_MASK,      PPE|COM,	PPCNONE,	{LI}},
{"bl",		B(18,0,1),	B_MASK,      PPE|COM,	PPCNONE,	{LI}},
{"ba",		B(18,1,0),	B_MASK,      PPE|COM,	PPCNONE,	{LIA}},
{"bla",		B(18,1,1),	B_MASK,      PPE|COM,	PPCNONE,	{LIA}},

{"mcrf",      XL(19,0), XLBB_MASK|(3<<21)|(3<<16), COM,	PPCNONE,	{BF, BFA}},

{"bdnzlr",   XLO(19,BODNZ,16,0),	XLBOBIBB_MASK, PPE|PPCCOM,	 PPCNONE,	{0}},
{"bdnzlr-",  XLO(19,BODNZ,16,0),	XLBOBIBB_MASK, PPE|PPCCOM,   ISA_V2,	{0}},
{"bdnzlrl",  XLO(19,BODNZ,16,1),	XLBOBIBB_MASK, PPE|PPCCOM,	 PPCNONE,	{0}},
{"bdnzlrl-", XLO(19,BODNZ,16,1),	XLBOBIBB_MASK, PPE|PPCCOM,   ISA_V2,	{0}},
{"bdnzlr+",  XLO(19,BODNZP,16,0),	XLBOBIBB_MASK, PPE|PPCCOM,   ISA_V2,	{0}},
{"bdnzlrl+", XLO(19,BODNZP,16,1),	XLBOBIBB_MASK, PPE|PPCCOM,   ISA_V2,	{0}},
{"bdzlr",    XLO(19,BODZ,16,0),		XLBOBIBB_MASK, PPE|PPCCOM,	 PPCNONE,	{0}},
{"bdzlr-",   XLO(19,BODZ,16,0),		XLBOBIBB_MASK, PPE|PPCCOM,   ISA_V2,	{0}},
{"bdzlrl",   XLO(19,BODZ,16,1),		XLBOBIBB_MASK, PPE|PPCCOM,	 PPCNONE,	{0}},
{"bdzlrl-",  XLO(19,BODZ,16,1),		XLBOBIBB_MASK, PPE|PPCCOM,   ISA_V2,	{0}},
{"bdzlr+",   XLO(19,BODZP,16,0),	XLBOBIBB_MASK, PPE|PPCCOM,   ISA_V2,	{0}},
{"bdzlrl+",  XLO(19,BODZP,16,1),	XLBOBIBB_MASK, PPE|PPCCOM,   ISA_V2,	{0}},
{"blr",      XLO(19,BOU,16,0),		XLBOBIBB_MASK, PPE|PPCCOM,	 PPCNONE,	{0}},
{"br",	     XLO(19,BOU,16,0),		XLBOBIBB_MASK, PWRCOM,	 PPCNONE,	{0}},
{"blrl",     XLO(19,BOU,16,1),		XLBOBIBB_MASK, PPE|PPCCOM,	 PPCNONE,	{0}},
...
{"bgelr",    XLOCB(19,BOF,CBLT,16,0),	XLBOCBBB_MASK, PPE|PPCCOM,	 PPCNONE,	{CR}},
{"bgelr-",   XLOCB(19,BOF,CBLT,16,0),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"bger",     XLOCB(19,BOF,CBLT,16,0),	XLBOCBBB_MASK, PWRCOM,	 PPCNONE,	{CR}},
{"bnllr",    XLOCB(19,BOF,CBLT,16,0),	XLBOCBBB_MASK, PPE|PPCCOM,	 PPCNONE,	{CR}},
{"bnllr-",   XLOCB(19,BOF,CBLT,16,0),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"bnlr",     XLOCB(19,BOF,CBLT,16,0),	XLBOCBBB_MASK, PWRCOM,	 PPCNONE,	{CR}},
{"bgelrl",   XLOCB(19,BOF,CBLT,16,1),	XLBOCBBB_MASK, PPE|PPCCOM,	 PPCNONE,	{CR}},
{"bgelrl-",  XLOCB(19,BOF,CBLT,16,1),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"bgerl",    XLOCB(19,BOF,CBLT,16,1),	XLBOCBBB_MASK, PWRCOM,	 PPCNONE,	{CR}},
{"bnllrl",   XLOCB(19,BOF,CBLT,16,1),	XLBOCBBB_MASK, PPE|PPCCOM,	 PPCNONE,	{CR}},
{"bnllrl-",  XLOCB(19,BOF,CBLT,16,1),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"bnlrl",    XLOCB(19,BOF,CBLT,16,1),	XLBOCBBB_MASK, PWRCOM,	 PPCNONE,	{CR}},
{"blelr",    XLOCB(19,BOF,CBGT,16,0),	XLBOCBBB_MASK, PPE|PPCCOM,	 PPCNONE,	{CR}},
{"blelr-",   XLOCB(19,BOF,CBGT,16,0),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"bler",     XLOCB(19,BOF,CBGT,16,0),	XLBOCBBB_MASK, PWRCOM,	 PPCNONE,	{CR}},
{"bnglr",    XLOCB(19,BOF,CBGT,16,0),	XLBOCBBB_MASK, PPE|PPCCOM,	 PPCNONE,	{CR}},
{"bnglr-",   XLOCB(19,BOF,CBGT,16,0),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"bngr",     XLOCB(19,BOF,CBGT,16,0),	XLBOCBBB_MASK, PWRCOM,	 PPCNONE,	{CR}},
{"blelrl",   XLOCB(19,BOF,CBGT,16,1),	XLBOCBBB_MASK, PPE|PPCCOM,	 PPCNONE,	{CR}},
{"blelrl-",  XLOCB(19,BOF,CBGT,16,1),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"blerl",    XLOCB(19,BOF,CBGT,16,1),	XLBOCBBB_MASK, PWRCOM,	 PPCNONE,	{CR}},
{"bnglrl",   XLOCB(19,BOF,CBGT,16,1),	XLBOCBBB_MASK, PPE|PPCCOM,	 PPCNONE,	{CR}},
{"bnglrl-",  XLOCB(19,BOF,CBGT,16,1),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"bngrl",    XLOCB(19,BOF,CBGT,16,1),	XLBOCBBB_MASK, PWRCOM,	 PPCNONE,	{CR}},
{"bnelr",    XLOCB(19,BOF,CBEQ,16,0),	XLBOCBBB_MASK, PPE|PPCCOM,	 PPCNONE,	{CR}},
{"bnelr-",   XLOCB(19,BOF,CBEQ,16,0),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"bner",     XLOCB(19,BOF,CBEQ,16,0),	XLBOCBBB_MASK, PWRCOM,	 PPCNONE,	{CR}},
{"bnelrl",   XLOCB(19,BOF,CBEQ,16,1),	XLBOCBBB_MASK, PPE|PPCCOM,	 PPCNONE,	{CR}},
{"bnelrl-",  XLOCB(19,BOF,CBEQ,16,1),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"bnerl",    XLOCB(19,BOF,CBEQ,16,1),	XLBOCBBB_MASK, PWRCOM,	 PPCNONE,	{CR}},
{"bnslr",    XLOCB(19,BOF,CBSO,16,0),	XLBOCBBB_MASK, PPE|PPCCOM,	 PPCNONE,	{CR}},
{"bnslr-",   XLOCB(19,BOF,CBSO,16,0),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"bnsr",     XLOCB(19,BOF,CBSO,16,0),	XLBOCBBB_MASK, PWRCOM,	 PPCNONE,	{CR}},
{"bnulr",    XLOCB(19,BOF,CBSO,16,0),	XLBOCBBB_MASK, PPE|PPCCOM,	 PPCNONE,	{CR}},
{"bnulr-",   XLOCB(19,BOF,CBSO,16,0),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"bnslrl",   XLOCB(19,BOF,CBSO,16,1),	XLBOCBBB_MASK, PPE|PPCCOM,	 PPCNONE,	{CR}},
{"bnslrl-",  XLOCB(19,BOF,CBSO,16,1),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"bnsrl",    XLOCB(19,BOF,CBSO,16,1),	XLBOCBBB_MASK, PWRCOM,	 PPCNONE,	{CR}},
{"bnulrl",   XLOCB(19,BOF,CBSO,16,1),	XLBOCBBB_MASK, PPE|PPCCOM,	 PPCNONE,	{CR}},
{"bnulrl-",  XLOCB(19,BOF,CBSO,16,1),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"bgelr+",   XLOCB(19,BOFP,CBLT,16,0),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"bnllr+",   XLOCB(19,BOFP,CBLT,16,0),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"bgelrl+",  XLOCB(19,BOFP,CBLT,16,1),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"bnllrl+",  XLOCB(19,BOFP,CBLT,16,1),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"blelr+",   XLOCB(19,BOFP,CBGT,16,0),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"bnglr+",   XLOCB(19,BOFP,CBGT,16,0),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"blelrl+",  XLOCB(19,BOFP,CBGT,16,1),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"bnglrl+",  XLOCB(19,BOFP,CBGT,16,1),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"bnelr+",   XLOCB(19,BOFP,CBEQ,16,0),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"bnelrl+",  XLOCB(19,BOFP,CBEQ,16,1),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"bnslr+",   XLOCB(19,BOFP,CBSO,16,0),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"bnulr+",   XLOCB(19,BOFP,CBSO,16,0),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"bnslrl+",  XLOCB(19,BOFP,CBSO,16,1),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"bnulrl+",  XLOCB(19,BOFP,CBSO,16,1),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
...
{"bltlr",    XLOCB(19,BOT,CBLT,16,0),	XLBOCBBB_MASK, PPE|PPCCOM,	 PPCNONE,	{CR}},
{"bltlr-",   XLOCB(19,BOT,CBLT,16,0),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"bltr",     XLOCB(19,BOT,CBLT,16,0),	XLBOCBBB_MASK, PWRCOM,	 PPCNONE,	{CR}},
{"bltlrl",   XLOCB(19,BOT,CBLT,16,1),	XLBOCBBB_MASK, PPE|PPCCOM,	 PPCNONE,	{CR}},
{"bltlrl-",  XLOCB(19,BOT,CBLT,16,1),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"bltrl",    XLOCB(19,BOT,CBLT,16,1),	XLBOCBBB_MASK, PWRCOM,	 PPCNONE,	{CR}},
{"bgtlr",    XLOCB(19,BOT,CBGT,16,0),	XLBOCBBB_MASK, PPE|PPCCOM,	 PPCNONE,	{CR}},
{"bgtlr-",   XLOCB(19,BOT,CBGT,16,0),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"bgtr",     XLOCB(19,BOT,CBGT,16,0),	XLBOCBBB_MASK, PWRCOM,	 PPCNONE,	{CR}},
{"bgtlrl",   XLOCB(19,BOT,CBGT,16,1),	XLBOCBBB_MASK, PPE|PPCCOM,	 PPCNONE,	{CR}},
{"bgtlrl-",  XLOCB(19,BOT,CBGT,16,1),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"bgtrl",    XLOCB(19,BOT,CBGT,16,1),	XLBOCBBB_MASK, PWRCOM,	 PPCNONE,	{CR}},
{"beqlr",    XLOCB(19,BOT,CBEQ,16,0),	XLBOCBBB_MASK, PPE|PPCCOM,	 PPCNONE,	{CR}},
{"beqlr-",   XLOCB(19,BOT,CBEQ,16,0),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"beqr",     XLOCB(19,BOT,CBEQ,16,0),	XLBOCBBB_MASK, PWRCOM,	 PPCNONE,	{CR}},
{"beqlrl",   XLOCB(19,BOT,CBEQ,16,1),	XLBOCBBB_MASK, PPE|PPCCOM,	 PPCNONE,	{CR}},
{"beqlrl-",  XLOCB(19,BOT,CBEQ,16,1),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"beqrl",    XLOCB(19,BOT,CBEQ,16,1),	XLBOCBBB_MASK, PWRCOM,	 PPCNONE,	{CR}},
{"bsolr",    XLOCB(19,BOT,CBSO,16,0),	XLBOCBBB_MASK, PPE|PPCCOM,	 PPCNONE,	{CR}},
{"bsolr-",   XLOCB(19,BOT,CBSO,16,0),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"bsor",     XLOCB(19,BOT,CBSO,16,0),	XLBOCBBB_MASK, PWRCOM,	 PPCNONE,	{CR}},
{"bunlr",    XLOCB(19,BOT,CBSO,16,0),	XLBOCBBB_MASK, PPE|PPCCOM,	 PPCNONE,	{CR}},
{"bunlr-",   XLOCB(19,BOT,CBSO,16,0),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"bsolrl",   XLOCB(19,BOT,CBSO,16,1),	XLBOCBBB_MASK, PPE|PPCCOM,	 PPCNONE,	{CR}},
{"bsolrl-",  XLOCB(19,BOT,CBSO,16,1),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"bsorl",    XLOCB(19,BOT,CBSO,16,1),	XLBOCBBB_MASK, PWRCOM,	 PPCNONE,	{CR}},
{"bunlrl",   XLOCB(19,BOT,CBSO,16,1),	XLBOCBBB_MASK, PPE|PPCCOM,	 PPCNONE,	{CR}},
{"bunlrl-",  XLOCB(19,BOT,CBSO,16,1),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"bltlr+",   XLOCB(19,BOTP,CBLT,16,0),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"bltlrl+",  XLOCB(19,BOTP,CBLT,16,1),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"bgtlr+",   XLOCB(19,BOTP,CBGT,16,0),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"bgtlrl+",  XLOCB(19,BOTP,CBGT,16,1),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"beqlr+",   XLOCB(19,BOTP,CBEQ,16,0),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"beqlrl+",  XLOCB(19,BOTP,CBEQ,16,1),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"bsolr+",   XLOCB(19,BOTP,CBSO,16,0),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"bunlr+",   XLOCB(19,BOTP,CBSO,16,0),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"bsolrl+",  XLOCB(19,BOTP,CBSO,16,1),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"bunlrl+",  XLOCB(19,BOTP,CBSO,16,1),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
...
{"bdnzflr",  XLO(19,BODNZF,16,0),	XLBOBB_MASK,   PPE|PPCCOM,	 PPCNONE,	{BI}},
{"bdnzflr-", XLO(19,BODNZF,16,0),	XLBOBB_MASK,   PPE|PPCCOM,   ISA_V2,	{BI}},
{"bdnzflrl", XLO(19,BODNZF,16,1),	XLBOBB_MASK,   PPE|PPCCOM,	 PPCNONE,	{BI}},
{"bdnzflrl-",XLO(19,BODNZF,16,1),	XLBOBB_MASK,   PPE|PPCCOM,   ISA_V2,	{BI}},
{"bdnzflr+", XLO(19,BODNZFP,16,0),	XLBOBB_MASK,   PPE|PPCCOM,   ISA_V2,	{BI}},
{"bdnzflrl+",XLO(19,BODNZFP,16,1),	XLBOBB_MASK,   PPE|PPCCOM,   ISA_V2,	{BI}},
{"bdzflr",   XLO(19,BODZF,16,0),	XLBOBB_MASK,   PPE|PPCCOM,	 PPCNONE,	{BI}},
{"bdzflr-",  XLO(19,BODZF,16,0),	XLBOBB_MASK,   PPE|PPCCOM,   ISA_V2,	{BI}},
{"bdzflrl",  XLO(19,BODZF,16,1),	XLBOBB_MASK,   PPE|PPCCOM,	 PPCNONE,	{BI}},
{"bdzflrl-", XLO(19,BODZF,16,1),	XLBOBB_MASK,   PPE|PPCCOM,   ISA_V2,	{BI}},
{"bdzflr+",  XLO(19,BODZFP,16,0),	XLBOBB_MASK,   PPE|PPCCOM,   ISA_V2,	{BI}},
{"bdzflrl+", XLO(19,BODZFP,16,1),	XLBOBB_MASK,   PPE|PPCCOM,   ISA_V2,	{BI}},
{"bflr",     XLO(19,BOF,16,0),		XLBOBB_MASK,   PPE|PPCCOM,	 PPCNONE,	{BI}},
{"bflr-",    XLO(19,BOF,16,0),		XLBOBB_MASK,   PPE|PPCCOM,   ISA_V2,	{BI}},
{"bbfr",     XLO(19,BOF,16,0),		XLBOBB_MASK,   PWRCOM,	 PPCNONE,	{BI}},
{"bflrl",    XLO(19,BOF,16,1),		XLBOBB_MASK,   PPE|PPCCOM,	 PPCNONE,	{BI}},
{"bflrl-",   XLO(19,BOF,16,1),		XLBOBB_MASK,   PPE|PPCCOM,   ISA_V2,	{BI}},
{"bbfrl",    XLO(19,BOF,16,1),		XLBOBB_MASK,   PWRCOM,	 PPCNONE,	{BI}},
{"bflr+",    XLO(19,BOFP,16,0),		XLBOBB_MASK,   PPE|PPCCOM,   ISA_V2,	{BI}},
{"bflrl+",   XLO(19,BOFP,16,1),		XLBOBB_MASK,   PPE|PPCCOM,   ISA_V2,	{BI}},
...
{"bdnztlr",  XLO(19,BODNZT,16,0),	XLBOBB_MASK,   PPE|PPCCOM,	 PPCNONE,	{BI}},
{"bdnztlr-", XLO(19,BODNZT,16,0),	XLBOBB_MASK,   PPE|PPCCOM,   ISA_V2,	{BI}},
{"bdnztlrl", XLO(19,BODNZT,16,1),	XLBOBB_MASK,   PPE|PPCCOM,	 PPCNONE,	{BI}},
{"bdnztlrl-",XLO(19,BODNZT,16,1),	XLBOBB_MASK,   PPE|PPCCOM,   ISA_V2,	{BI}},
{"bdnztlr+", XLO(19,BODNZTP,16,0),	XLBOBB_MASK,   PPE|PPCCOM,   ISA_V2,	{BI}},
{"bdnztlrl+",XLO(19,BODNZTP,16,1),	XLBOBB_MASK,   PPE|PPCCOM,   ISA_V2,	{BI}},
{"bdztlr",   XLO(19,BODZT,16,0),	XLBOBB_MASK,   PPE|PPCCOM,	 PPCNONE,	{BI}},
{"bdztlr-",  XLO(19,BODZT,16,0),	XLBOBB_MASK,   PPE|PPCCOM,   ISA_V2,	{BI}},
{"bdztlrl",  XLO(19,BODZT,16,1),	XLBOBB_MASK,   PPE|PPCCOM,	 PPCNONE,	{BI}},
{"bdztlrl-", XLO(19,BODZT,16,1),	XLBOBB_MASK,   PPE|PPCCOM,   ISA_V2,	{BI}},
{"bdztlr+",  XLO(19,BODZTP,16,0),	XLBOBB_MASK,   PPE|PPCCOM,   ISA_V2,	{BI}},
{"bdztlrl+", XLO(19,BODZTP,16,1),	XLBOBB_MASK,   PPE|PPCCOM,   ISA_V2,	{BI}},
{"btlr",     XLO(19,BOT,16,0),		XLBOBB_MASK,   PPE|PPCCOM,	 PPCNONE,	{BI}},
{"btlr-",    XLO(19,BOT,16,0),		XLBOBB_MASK,   PPE|PPCCOM,   ISA_V2,	{BI}},
{"bbtr",     XLO(19,BOT,16,0),		XLBOBB_MASK,   PWRCOM,	 PPCNONE,	{BI}},
{"btlrl",    XLO(19,BOT,16,1),		XLBOBB_MASK,   PPE|PPCCOM,	 PPCNONE,	{BI}},
{"btlrl-",   XLO(19,BOT,16,1),		XLBOBB_MASK,   PPE|PPCCOM,   ISA_V2,	{BI}},
{"bbtrl",    XLO(19,BOT,16,1),		XLBOBB_MASK,   PWRCOM,	 PPCNONE,	{BI}},
{"btlr+",    XLO(19,BOTP,16,0),		XLBOBB_MASK,   PPE|PPCCOM,   ISA_V2,	{BI}},
{"btlrl+",   XLO(19,BOTP,16,1),		XLBOBB_MASK,   PPE|PPCCOM,   ISA_V2,	{BI}},
...
{"bclr-",    XLYLK(19,16,0,0),		XLYBB_MASK,    PPE|PPCCOM,	 PPCNONE,	{BOE, BI}},
{"bclrl-",   XLYLK(19,16,0,1),		XLYBB_MASK,    PPE|PPCCOM,	 PPCNONE,	{BOE, BI}},
{"bclr+",    XLYLK(19,16,1,0),		XLYBB_MASK,    PPE|PPCCOM,	 PPCNONE,	{BOE, BI}},
{"bclrl+",   XLYLK(19,16,1,1),		XLYBB_MASK,    PPE|PPCCOM,	 PPCNONE,	{BOE, BI}},
{"bclr",     XLLK(19,16,0),		XLBH_MASK,     PPE|PPCCOM,	 PPCNONE,	{BO, BI, BH}},
{"bcr",      XLLK(19,16,0),		XLBB_MASK,     PWRCOM,	 PPCNONE,	{BO, BI}},
{"bclrl",    XLLK(19,16,1),		XLBH_MASK,     PPE|PPCCOM,	 PPCNONE,	{BO, BI, BH}},
...
{"rfi",		XL(19,50),	0xffffffff,  PPE|COM,	PPCNONE,	{0}},
...
{"bctr",    XLO(19,BOU,528,0),		XLBOBIBB_MASK, PPE|COM,	 PPCNONE,	{0}},
{"bctrl",   XLO(19,BOU,528,1),		XLBOBIBB_MASK, PPE|COM,	 PPCNONE,	{0}},

{"bgectr",  XLOCB(19,BOF,CBLT,528,0),	XLBOCBBB_MASK, PPE|PPCCOM,  PPCNONE,	{CR}},
{"bgectr-", XLOCB(19,BOF,CBLT,528,0),	XLBOCBBB_MASK, PPE|PPCCOM,  ISA_V2,	{CR}},
{"bnlctr",  XLOCB(19,BOF,CBLT,528,0),	XLBOCBBB_MASK, PPE|PPCCOM, PPCNONE,	{CR}},
{"bnlctr-", XLOCB(19,BOF,CBLT,528,0),	XLBOCBBB_MASK, PPE|PPCCOM,  ISA_V2,	{CR}},
{"bgectrl", XLOCB(19,BOF,CBLT,528,1),	XLBOCBBB_MASK, PPE|PPCCOM, PPCNONE,	{CR}},
{"bgectrl-",XLOCB(19,BOF,CBLT,528,1),	XLBOCBBB_MASK, PPE|PPCCOM,  ISA_V2,	{CR}},
{"bnlctrl", XLOCB(19,BOF,CBLT,528,1),	XLBOCBBB_MASK, PPE|PPCCOM, PPCNONE,	{CR}},
{"bnlctrl-",XLOCB(19,BOF,CBLT,528,1),	XLBOCBBB_MASK, PPE|PPCCOM,  ISA_V2,	{CR}},
{"blectr",  XLOCB(19,BOF,CBGT,528,0),	XLBOCBBB_MASK, PPE|PPCCOM, PPCNONE,	{CR}},
{"blectr-", XLOCB(19,BOF,CBGT,528,0),	XLBOCBBB_MASK, PPE|PPCCOM,  ISA_V2,	{CR}},
{"bngctr",  XLOCB(19,BOF,CBGT,528,0),	XLBOCBBB_MASK, PPE|PPCCOM, PPCNONE,	{CR}},
{"bngctr-", XLOCB(19,BOF,CBGT,528,0),	XLBOCBBB_MASK, PPE|PPCCOM,  ISA_V2,	{CR}},
{"blectrl", XLOCB(19,BOF,CBGT,528,1),	XLBOCBBB_MASK, PPE|PPCCOM, PPCNONE,	{CR}},
{"blectrl-",XLOCB(19,BOF,CBGT,528,1),	XLBOCBBB_MASK, PPE|PPCCOM,  ISA_V2,	{CR}},
{"bngctrl", XLOCB(19,BOF,CBGT,528,1),	XLBOCBBB_MASK, PPE|PPCCOM, PPCNONE,	{CR}},
{"bngctrl-",XLOCB(19,BOF,CBGT,528,1),	XLBOCBBB_MASK, PPE|PPCCOM,  ISA_V2,	{CR}},
{"bnectr",  XLOCB(19,BOF,CBEQ,528,0),	XLBOCBBB_MASK, PPE|PPCCOM, PPCNONE,	{CR}},
{"bnectr-", XLOCB(19,BOF,CBEQ,528,0),	XLBOCBBB_MASK, PPE|PPCCOM,  ISA_V2,	{CR}},
{"bnectrl", XLOCB(19,BOF,CBEQ,528,1),	XLBOCBBB_MASK, PPE|PPCCOM, PPCNONE,	{CR}},
{"bnectrl-",XLOCB(19,BOF,CBEQ,528,1),	XLBOCBBB_MASK, PPE|PPCCOM,  ISA_V2,	{CR}},
{"bnsctr",  XLOCB(19,BOF,CBSO,528,0),	XLBOCBBB_MASK, PPE|PPCCOM, PPCNONE,	{CR}},
{"bnsctr-", XLOCB(19,BOF,CBSO,528,0),	XLBOCBBB_MASK, PPE|PPCCOM,  ISA_V2,	{CR}},
{"bnuctr",  XLOCB(19,BOF,CBSO,528,0),	XLBOCBBB_MASK, PPE|PPCCOM, PPCNONE,	{CR}},
{"bnuctr-", XLOCB(19,BOF,CBSO,528,0),	XLBOCBBB_MASK, PPE|PPCCOM,  ISA_V2,	{CR}},
{"bnsctrl", XLOCB(19,BOF,CBSO,528,1),	XLBOCBBB_MASK, PPE|PPCCOM, PPCNONE,	{CR}},
{"bnsctrl-",XLOCB(19,BOF,CBSO,528,1),	XLBOCBBB_MASK, PPE|PPCCOM,  ISA_V2,	{CR}},
{"bnuctrl", XLOCB(19,BOF,CBSO,528,1),	XLBOCBBB_MASK, PPE|PPCCOM, PPCNONE,	{CR}},
{"bnuctrl-",XLOCB(19,BOF,CBSO,528,1),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"bgectr+", XLOCB(19,BOFP,CBLT,528,0),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"bnlctr+", XLOCB(19,BOFP,CBLT,528,0),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"bgectrl+",XLOCB(19,BOFP,CBLT,528,1),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"bnlctrl+",XLOCB(19,BOFP,CBLT,528,1),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"blectr+", XLOCB(19,BOFP,CBGT,528,0),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"bngctr+", XLOCB(19,BOFP,CBGT,528,0),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"blectrl+",XLOCB(19,BOFP,CBGT,528,1),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"bngctrl+",XLOCB(19,BOFP,CBGT,528,1),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"bnectr+", XLOCB(19,BOFP,CBEQ,528,0),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"bnectrl+",XLOCB(19,BOFP,CBEQ,528,1),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"bnsctr+", XLOCB(19,BOFP,CBSO,528,0),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"bnuctr+", XLOCB(19,BOFP,CBSO,528,0),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"bnsctrl+",XLOCB(19,BOFP,CBSO,528,1),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"bnuctrl+",XLOCB(19,BOFP,CBSO,528,1),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
...
{"bltctr",  XLOCB(19,BOT,CBLT,528,0),	XLBOCBBB_MASK, PPE|PPCCOM,	 PPCNONE,	{CR}},
{"bltctr-", XLOCB(19,BOT,CBLT,528,0),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"bltctrl", XLOCB(19,BOT,CBLT,528,1),	XLBOCBBB_MASK, PPE|PPCCOM,	 PPCNONE,	{CR}},
{"bltctrl-",XLOCB(19,BOT,CBLT,528,1),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"bgtctr",  XLOCB(19,BOT,CBGT,528,0),	XLBOCBBB_MASK, PPE|PPCCOM,	 PPCNONE,	{CR}},
{"bgtctr-", XLOCB(19,BOT,CBGT,528,0),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"bgtctrl", XLOCB(19,BOT,CBGT,528,1),	XLBOCBBB_MASK, PPE|PPCCOM,	 PPCNONE,	{CR}},
{"bgtctrl-",XLOCB(19,BOT,CBGT,528,1),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"beqctr",  XLOCB(19,BOT,CBEQ,528,0),	XLBOCBBB_MASK, PPE|PPCCOM, PPCNONE,	{CR}},
{"beqctr-", XLOCB(19,BOT,CBEQ,528,0),	XLBOCBBB_MASK, PPE|PPCCOM, ISA_V2,	{CR}},
{"beqctrl", XLOCB(19,BOT,CBEQ,528,1),	XLBOCBBB_MASK, PPE|PPCCOM, PPCNONE,	{CR}},
{"beqctrl-",XLOCB(19,BOT,CBEQ,528,1),	XLBOCBBB_MASK, PPE|PPCCOM, ISA_V2,	{CR}},
{"bsoctr",  XLOCB(19,BOT,CBSO,528,0),	XLBOCBBB_MASK, PPE|PPCCOM,	 PPCNONE,	{CR}},
{"bsoctr-", XLOCB(19,BOT,CBSO,528,0),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"bunctr",  XLOCB(19,BOT,CBSO,528,0),	XLBOCBBB_MASK, PPE|PPCCOM,	 PPCNONE,	{CR}},
{"bunctr-", XLOCB(19,BOT,CBSO,528,0),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"bsoctrl", XLOCB(19,BOT,CBSO,528,1),	XLBOCBBB_MASK, PPE|PPCCOM,	 PPCNONE,	{CR}},
{"bsoctrl-",XLOCB(19,BOT,CBSO,528,1),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"bunctrl", XLOCB(19,BOT,CBSO,528,1),	XLBOCBBB_MASK, PPE|PPCCOM,	 PPCNONE,	{CR}},
{"bunctrl-",XLOCB(19,BOT,CBSO,528,1),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"bltctr+", XLOCB(19,BOTP,CBLT,528,0),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"bltctrl+",XLOCB(19,BOTP,CBLT,528,1),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"bgtctr+", XLOCB(19,BOTP,CBGT,528,0),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"bgtctrl+",XLOCB(19,BOTP,CBGT,528,1),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"beqctr+", XLOCB(19,BOTP,CBEQ,528,0),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"beqctrl+",XLOCB(19,BOTP,CBEQ,528,1),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"bsoctr+", XLOCB(19,BOTP,CBSO,528,0),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"bunctr+", XLOCB(19,BOTP,CBSO,528,0),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"bsoctrl+",XLOCB(19,BOTP,CBSO,528,1),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
{"bunctrl+",XLOCB(19,BOTP,CBSO,528,1),	XLBOCBBB_MASK, PPE|PPCCOM,   ISA_V2,	{CR}},
...
{"bcctr-",  XLYLK(19,528,0,0),		XLYBB_MASK,    PPE|PPCCOM,  PPCNONE,	{BOE, BI}},
{"bcctrl-", XLYLK(19,528,0,1),		XLYBB_MASK,    PPE|PPCCOM,  PPCNONE,	{BOE, BI}},
{"bcctr+",  XLYLK(19,528,1,0),		XLYBB_MASK,    PPE|PPCCOM,  PPCNONE,	{BOE, BI}},
{"bcctrl+", XLYLK(19,528,1,1),		XLYBB_MASK,    PPE|PPCCOM,  PPCNONE,	{BOE, BI}},
{"bcctr",   XLLK(19,528,0),		XLBH_MASK,     PPE|PPCCOM,  PPCNONE,	{BO, BI, BH}},
{"bcc",     XLLK(19,528,0),		XLBB_MASK,     PWRCOM,	 PPCNONE,	{BO, BI}},
{"bcctrl",  XLLK(19,528,1),		XLBH_MASK,     PPE|PPCCOM,	 PPCNONE,	{BO, BI, BH}},
...
{"rlwimi",	M(20,0),	M_MASK,      PPE|PPCCOM,	PPCNONE,	{RA, RS, SH, MBE, ME}},
{"rlimi",	M(20,0),	M_MASK,      PWRCOM,	PPCNONE,	{RA, RS, SH, MBE, ME}},

{"rlwimi.",	M(20,1),	M_MASK,      PPE|PPCCOM,	PPCNONE,	{RA, RS, SH, MBE, ME}},
{"rlimi.",	M(20,1),	M_MASK,      PWRCOM,	PPCNONE,	{RA, RS, SH, MBE, ME}},

{"rotlwi",	MME(21,31,0),	MMBME_MASK,  PPE|PPCCOM,	PPCNONE,	{RA, RS, SH}},
{"clrlwi",	MME(21,31,0),	MSHME_MASK,  PPE|PPCCOM,	PPCNONE,	{RA, RS, MB}},
{"rlwinm",	M(21,0),	M_MASK,      PPE|PPCCOM,	PPCNONE,	{RA, RS, SH, MBE, ME}},
{"rlinm",	M(21,0),	M_MASK,      PWRCOM,	PPCNONE,	{RA, RS, SH, MBE, ME}},
{"rotlwi.",	MME(21,31,1),	MMBME_MASK,  PPE|PPCCOM,	PPCNONE,	{RA, RS, SH}},
{"clrlwi.",	MME(21,31,1),	MSHME_MASK,  PPE|PPCCOM,	PPCNONE,	{RA, RS, MB}},
{"rlwinm.",	M(21,1),	M_MASK,      PPE|PPCCOM,	PPCNONE,	{RA, RS, SH, MBE, ME}},
{"rlinm.",	M(21,1),	M_MASK,      PWRCOM,	PPCNONE,	{RA, RS, SH, MBE, ME}},

{"stvdu",	OP(22),		OP_MASK,     PPE,	PPCNONE,	{VDS, D, RA}},
{"rlmi",	M(22,0),	M_MASK,      M601,	PPCNONE,	{RA, RS, RB, MBE, ME}},
{"rlmi.",	M(22,1),	M_MASK,      M601,	PPCNONE,	{RA, RS, RB, MBE, ME}},

{"rotlw",	MME(23,31,0),	MMBME_MASK,  PPE|PPCCOM,	PPCNONE,	{RA, RS, RB}},
{"rlwnm",	M(23,0),	M_MASK,      PPE|PPCCOM,	PPCNONE,	{RA, RS, RB, MBE, ME}},
{"rlnm",	M(23,0),	M_MASK,      PWRCOM,	PPCNONE,	{RA, RS, RB, MBE, ME}},
{"rotlw.",	MME(23,31,1),	MMBME_MASK,  PPE|PPCCOM,	PPCNONE,	{RA, RS, RB}},
{"rlwnm.",	M(23,1),	M_MASK,      PPE|PPCCOM,	PPCNONE,	{RA, RS, RB, MBE, ME}},
{"rlnm.",	M(23,1),	M_MASK,      PWRCOM,	PPCNONE,	{RA, RS, RB, MBE, ME}},

{"nop",		OP(24),		0xffffffff,  PPE|PPCCOM,	PPCNONE,	{0}},
{"ori",		OP(24),		OP_MASK,     PPE|PPCCOM,	PPCNONE,	{RA, RS, UI}},
{"oril",	OP(24),		OP_MASK,     PWRCOM,	PPCNONE,	{RA, RS, UI}},

{"oris",	OP(25),		OP_MASK,     PPE|PPCCOM,	PPCNONE,	{RA, RS, UI}},
{"oriu",	OP(25),		OP_MASK,     PWRCOM,	PPCNONE,	{RA, RS, UI}},

{"xnop",	OP(26),		0xffffffff,  PPE|PPCCOM,	PPCNONE,	{0}},
{"xori",	OP(26),		OP_MASK,     PPE|PPCCOM,	PPCNONE,	{RA, RS, UI}},
{"xoril",	OP(26),		OP_MASK,     PWRCOM,	PPCNONE,	{RA, RS, UI}},

{"xoris",	OP(27),		OP_MASK,     PPE|PPCCOM,	PPCNONE,	{RA, RS, UI}},
{"xoriu",	OP(27),		OP_MASK,     PWRCOM,	PPCNONE,	{RA, RS, UI}},

{"andi.",	OP(28),		OP_MASK,     PPE|PPCCOM,	PPCNONE,	{RA, RS, UI}},
{"andil.",	OP(28),		OP_MASK,     PWRCOM,	PPCNONE,	{RA, RS, UI}},

{"andis.",	OP(29),		OP_MASK,     PPE|PPCCOM,	PPCNONE,	{RA, RS, UI}},
{"andiu.",	OP(29),		OP_MASK,     PWRCOM,	PPCNONE,	{RA, RS, UI}},

{"rotldi",	MD(30,0,0),	MDMB_MASK,   PPC64,	PPCNONE,	{RA, RS, SH6}},
{"clrldi",	MD(30,0,0),	MDSH_MASK,   PPEX|PPC64,	PPCNONE,	{VDA, VDS, MB6}},
{"rldicl",	MD(30,0,0),	MD_MASK,     PPEX|PPC64,	PPCNONE,	{VDA, VDS, SH6, MB6}},
{"rotldi.",	MD(30,0,1),	MDMB_MASK,   PPC64,	PPCNONE,	{RA, RS, SH6}},
{"clrldi.",	MD(30,0,1),	MDSH_MASK,   PPEX|PPC64,	PPCNONE,	{VDA, VDS, MB6}},
{"rldicl.",	MD(30,0,1),	MD_MASK,     PPEX|PPC64,	PPCNONE,	{VDA, VDS, SH6, MB6}},

{"rldicr",	MD(30,1,0),	MD_MASK,     PPEX|PPC64,	PPCNONE,	{VDA, VDS, SH6, ME6}},
{"rldicr.",	MD(30,1,1),	MD_MASK,     PPEX|PPC64,	PPCNONE,	{VDA, VDS, SH6, ME6}},

{"rldic",	MD(30,2,0),	MD_MASK,     PPC64,	PPCNONE,	{RA, RS, SH6, MB6}},
{"rldic.",	MD(30,2,1),	MD_MASK,     PPC64,	PPCNONE,	{RA, RS, SH6, MB6}},

{"rldimi",	MD(30,3,0),	MD_MASK,     PPEX|PPC64,	PPCNONE,	{VDA, VDS, SH6, MB6}},
{"rldimi.",	MD(30,3,1),	MD_MASK,     PPEX|PPC64,	PPCNONE,	{VDA, VDS, SH6, MB6}},
...
{"cmpw",	XOPL(31,0,0),	XCMPL_MASK,  PPE|PPCCOM,	PPCNONE,	{OBF, RA, RB}},
{"cmpd",	XOPL(31,0,1),	XCMPL_MASK,  PPC64,	PPCNONE,	{OBF, RA, RB}},
{"cmp",		X(31,0),	XCMP_MASK,   PPE|PPCCOM|PPCVLE, PPCNONE,	{BF, L, RA, RB}},
...
{"trap",	XTO(31,4,TOU),	 0xffffffff, PPE|PPCCOM|PPCVLE, PPCNONE,	{0}},
{"mark",	XTO(31,4,0),	 XTO_MASK, PPE|PPCCOM|PPCVLE, PPCNONE,	{RA, RB}},
{"twu",		XTO(31,4,TOU),	 XTO_MASK,   PPE|PPCCOM|PPCVLE, PPCNONE,	{RA, RB}},
{"tu",		XTO(31,4,TOU),	 XTO_MASK,   PWRCOM,	PPCNONE,	{RA, RB}},
{"tw",		X(31,4),	 X_MASK, PPE|PPCCOM|PPCVLE, PPCNONE,	{TO, RA, RB}},
{"t",		X(31,4),	 X_MASK,     PWRCOM,	PPCNONE,	{TO, RA, RB}},
{"marktag", XRC(31,4,1), X_MASK, PPE, PPCNONE,{B6_B15}},
...
{"subfc",	XO(31,8,0,0),	XO_MASK,     PPE|PPCCOM|PPCVLE, PPCNONE,	{RT, RA, RB}},
{"sf",		XO(31,8,0,0),	XO_MASK,     PWRCOM,	PPCNONE,	{RT, RA, RB}},
{"subc",	XO(31,8,0,0),	XO_MASK,     PPE|PPCCOM|PPCVLE, PPCNONE,	{RT, RB, RA}},
{"subfc.",	XO(31,8,0,1),	XO_MASK,     PPE|PPCCOM|PPCVLE, PPCNONE,	{RT, RA, RB}},
{"sf.",		XO(31,8,0,1),	XO_MASK,     PWRCOM,	PPCNONE,	{RT, RA, RB}},
{"subc.",	XO(31,8,0,1),	XO_MASK,     PPE|PPCCOM|PPCVLE, PPCNONE,	{RT, RB, RA}},
 
{"mulhdu",	XO(31,9,0,0),	XO_MASK,     PPC64|PPCVLE, PPCNONE,	{RT, RA, RB}},
{"mulhdu.",	XO(31,9,0,1),	XO_MASK,     PPC64|PPCVLE, PPCNONE,	{RT, RA, RB}},
 
{"addc",	XO(31,10,0,0),	XO_MASK,     PPE|PPCCOM|PPCVLE, PPCNONE,	{RT, RA, RB}},
{"a",		XO(31,10,0,0),	XO_MASK,     PWRCOM,	PPCNONE,	{RT, RA, RB}},
{"addc.",	XO(31,10,0,1),	XO_MASK,     PPE|PPCCOM|PPCVLE, PPCNONE,	{RT, RA, RB}},
...
{"lvdx",	X(31,17),	X_MASK,     PPE,	PPCNONE,	{VDT, RA, RB}},
...
{"mfcr",	XFXM(31,19,0,0), XRARB_MASK, PPE|COM|PPCVLE, POWER4,	{RT}},
...
{"lwzx",	X(31,23),	X_MASK,	     PPE|PPCCOM|PPCVLE, PPCNONE,	{RT, RA0, RB}},
{"lx",		X(31,23),	X_MASK,      PWRCOM,	PPCNONE,	{RT, RA, RB}},

{"slw",		XRC(31,24,0),	X_MASK,	     PPE|PPCCOM|PPCVLE, PPCNONE,	{RA, RS, RB}},
{"sl",		XRC(31,24,0),	X_MASK,      PWRCOM,	PPCNONE,	{RA, RS, RB}},
{"slw.",	XRC(31,24,1),	X_MASK,	     PPE|PPCCOM|PPCVLE, PPCNONE,	{RA, RS, RB}},
{"sl.",		XRC(31,24,1),	X_MASK,      PWRCOM,	PPCNONE,	{RA, RS, RB}},

{"cntlzw",	XRC(31,26,0),	XRB_MASK,    PPE|PPCCOM|PPCVLE, PPCNONE,	{RA, RS}},
{"cntlz",	XRC(31,26,0),	XRB_MASK,    PWRCOM,	PPCNONE,	{RA, RS}},
{"cntlzw.",	XRC(31,26,1),	XRB_MASK,    PPE|PPCCOM|PPCVLE, PPCNONE,	{RA, RS}},
...
{"and",		XRC(31,28,0),	X_MASK,      PPE|COM|PPCVLE, PPCNONE,	{RA, RS, RB}},
{"and.",	XRC(31,28,1),	X_MASK,	     PPE|COM|PPCVLE, PPCNONE,	{RA, RS, RB}},
...
{"cmplw",	XOPL(31,32,0),	XCMPL_MASK,  PPE|PPCCOM|PPCVLE, PPCNONE,	{OBF, RA, RB}},
{"cmpld",	XOPL(31,32,1),	XCMPL_MASK,  PPC64,	PPCNONE,	{OBF, RA, RB}},
{"cmpl",	X(31,32),	XCMP_MASK,   PPE|PPC|PPCVLE, PPCNONE,	{BF, L, RA, RB}},
...
//{"lvdux",	X(31,49),	X_MASK,     PPE,	PPCNONE,	{VDT, RA, RB}},
...
{"subf",	XO(31,40,0,0),	XO_MASK,     PPE|PPC|PPCVLE, PPCNONE,	{RT, RA, RB}},
{"sub",		XO(31,40,0,0),	XO_MASK,     PPE|PPC|PPCVLE, PPCNONE,	{RT, RB, RA}},
{"subf.",	XO(31,40,0,1),	XO_MASK,     PPE|PPC|PPCVLE, PPCNONE,	{RT, RA, RB}},
{"sub.",	XO(31,40,0,1),	XO_MASK,     PPE|PPC|PPCVLE, PPCNONE,	{RT, RB, RA}},
...
{"slvd",	XRC(31,59,0),	X_MASK,       PPEX, PPCNONE,	{VDA, VDS, RB}},
{"slvd.",	XRC(31,59,1),	X_MASK,       PPEX, PPCNONE,	{VDA, VDS, RB}},

{"andc",	XRC(31,60,0),	X_MASK,	     PPE|COM|PPCVLE, PPCNONE,	{RA, RS, RB}},
{"andc.",	XRC(31,60,1),	X_MASK,	     PPE|COM|PPCVLE, PPCNONE,	{RA, RS, RB}},
...
{"mfmsr",	X(31,83),	XRARB_MASK,  PPE|COM|PPCVLE, PPCNONE,	{RT}},
 
{"ldarx",	X(31,84),	XEH_MASK,    PPC64|PPCVLE, PPCNONE,	{RT, RA0, RB, EH}},

{"dcbfl",	XOPL(31,86,1),	XRT_MASK,    POWER5,	PPC476,		{RA0, RB}},
{"dcbf",	X(31,86),	XLRT_MASK,   PPE|PPC|PPCVLE, PPCNONE,	{RA0, RB, L}},

{"lbzx",	X(31,87),	X_MASK,	     PPE|COM|PPCVLE, PPCNONE,	{RT, RA0, RB}},
...
{"neg",		XO(31,104,0,0),	XORB_MASK,   PPE|COM|PPCVLE, PPCNONE,	{RT, RA}},
{"neg.",	XO(31,104,0,1),	XORB_MASK,   PPE|COM|PPCVLE, PPCNONE,	{RT, RA}},
...
{"not",		XRC(31,124,0),	X_MASK,      PPE|COM,	PPCNONE,	{RA, RS, RBS}},
{"nor",		XRC(31,124,0),	X_MASK,	     PPE|COM|PPCVLE, PPCNONE,	{RA, RS, RB}},
{"not.",	XRC(31,124,1),	X_MASK,      PPE|COM,	PPCNONE,	{RA, RS, RBS}},
{"nor.",	XRC(31,124,1),	X_MASK,      PPE|COM|PPCVLE, PPCNONE,	{RA, RS, RB}},

{"dcbfep",	XRT(31,127,0),	XRT_MASK,    E500MC|PPCA2|PPCVLE, PPCNONE, {RA0, RB}},
 
{"wrtee",	X(31,131),	XRARB_MASK,  PPE|PPC403|BOOKE|PPCA2|PPC476|PPCVLE, PPCNONE, {RS}},
...
{"subfe",	XO(31,136,0,0),	XO_MASK,     PPE|PPCCOM|PPCVLE, PPCNONE,	{RT, RA, RB}},
{"sfe",		XO(31,136,0,0),	XO_MASK,     PWRCOM,	PPCNONE,	{RT, RA, RB}},
{"subfe.",	XO(31,136,0,1),	XO_MASK,     PPE|PPCCOM|PPCVLE, PPCNONE,	{RT, RA, RB}},
{"sfe.",	XO(31,136,0,1),	XO_MASK,     PWRCOM,	PPCNONE,	{RT, RA, RB}},

{"adde",	XO(31,138,0,0),	XO_MASK,     PPE|PPCCOM|PPCVLE, PPCNONE,	{RT, RA, RB}},
{"ae",		XO(31,138,0,0),	XO_MASK,     PWRCOM,	PPCNONE,	{RT, RA, RB}},
{"adde.",	XO(31,138,0,1),	XO_MASK,     PPE|PPCCOM|PPCVLE, PPCNONE,	{RT, RA, RB}},
...
{"mtcr0",       XFXM(31,144,128,0), XRARB_MASK, PPE,       PPCNONE,        {RS}},
{"mtcr",	XFXM(31,144,0xff,0), XRARB_MASK, COM,	PPCNONE,	{RS}},
{"mtcrf",	XFXM(31,144,0,0), XFXFXM_MASK, PPE|COM|PPCVLE, PPCNONE,	{FXM, RS}},
{"mtocrf",	XFXM(31,144,0,1), XFXFXM_MASK, COM|PPCVLE, PPCNONE,	{FXM, RS}},

{"mtmsr",	X(31,146),	XRLARB_MASK, PPE|COM|PPCVLE, PPCNONE,	{RS, A_L}},
...
{"stwx",	X(31,151),	X_MASK,      PPE|PPCCOM|PPCVLE, PPCNONE,	{RS, RA0, RB}},
{"stx",		X(31,151),	X_MASK,      PWRCOM,	PPCNONE,	{RS, RA, RB}},
{"stvdx",	X(31,145),	X_MASK,      PPE,	PPCNONE,	{VDS, RA, RB}},
...
{"wrteei",	X(31,163),	XE_MASK,     PPE|PPC403|BOOKE|PPCA2|PPC476|PPCVLE, PPCNONE, {E}},
...
//{"stvdux",	X(31,177),	X_MASK,      PPE,	PPCNONE,	{VDS, RA, RB}},
...
{"subfze",	XO(31,200,0,0),	XORB_MASK,   PPE|PPCCOM|PPCVLE, PPCNONE,	{RT, RA}},
{"sfze",	XO(31,200,0,0),	XORB_MASK,   PWRCOM,	PPCNONE,	{RT, RA}},
{"subfze.",	XO(31,200,0,1),	XORB_MASK,   PPE|PPCCOM|PPCVLE, PPCNONE,	{RT, RA}},
{"sfze.",	XO(31,200,0,1),	XORB_MASK,   PWRCOM,	PPCNONE,	{RT, RA}},

{"addze",	XO(31,202,0,0),	XORB_MASK,   PPE|PPCCOM|PPCVLE, PPCNONE,	{RT, RA}},
{"aze",		XO(31,202,0,0),	XORB_MASK,   PWRCOM,	PPCNONE,	{RT, RA}},
{"addze.",	XO(31,202,0,1),	XORB_MASK,   PPE|PPCCOM|PPCVLE, PPCNONE,	{RT, RA}},
...
{"stbx",	X(31,215),	X_MASK,	     PPE|COM|PPCVLE, PPCNONE,	{RS, RA0, RB}},
...
{"subfme",	XO(31,232,0,0),	XORB_MASK,   PPE|PPCCOM|PPCVLE, PPCNONE,	{RT, RA}},
{"sfme",	XO(31,232,0,0),	XORB_MASK,   PWRCOM,	PPCNONE,	{RT, RA}},
{"subfme.",	XO(31,232,0,1),	XORB_MASK,   PPE|PPCCOM|PPCVLE, PPCNONE,	{RT, RA}},
...
{"addme",	XO(31,234,0,0),	XORB_MASK,   PPE|PPCCOM|PPCVLE, PPCNONE,	{RT, RA}},
{"ame",		XO(31,234,0,0),	XORB_MASK,   PWRCOM,	PPCNONE,	{RT, RA}},
{"addme.",	XO(31,234,0,1),	XORB_MASK,   PPE|PPCCOM|PPCVLE, PPCNONE,	{RT, RA}},
{"ame.",	XO(31,234,0,1),	XORB_MASK,   PWRCOM,	PPCNONE,	{RT, RA}},

{"mullw",	XO(31,235,0,0),	XO_MASK,     PPEX|PPCCOM|PPCVLE, PPCNONE,	{RT, RA, RB}},
{"muls",	XO(31,235,0,0),	XO_MASK,     PWRCOM,	PPCNONE,	{RT, RA, RB}},
{"mullw.",	XO(31,235,0,1),	XO_MASK,     PPEX|PPCCOM|PPCVLE, PPCNONE,	{RT, RA, RB}},
...
{"add",		XO(31,266,0,0),	XO_MASK,     PPE|PPCCOM|PPCVLE, PPCNONE,	{RT, RA, RB}},
{"cax",		XO(31,266,0,0),	XO_MASK,     PWRCOM,	PPCNONE,	{RT, RA, RB}},
{"add.",	XO(31,266,0,1),	XO_MASK,     PPE|PPCCOM|PPCVLE, PPCNONE,	{RT, RA, RB}},
...
{"dcbt",	X(31,278),	X_MASK,      PPE|PPC|PPCVLE, POWER4,	{CT, RA0, RB}},
 
{"lhzx",	X(31,279),	X_MASK,      PPE|COM|PPCVLE, PPCNONE,	{RT, RA0, RB}},

{"cdtbcd",	X(31,282),	XRB_MASK,    POWER6,	PPCNONE,	{RA, RS}},

{"eqv",		XRC(31,284,0),	X_MASK,      PPE|COM|PPCVLE, PPCNONE,	{RA, RS, RB}},
{"eqv.",	XRC(31,284,1),	X_MASK,	     PPE|COM|PPCVLE, PPCNONE,	{RA, RS, RB}},
...
{"xor",		XRC(31,316,0),	X_MASK,      PPE|COM|PPCVLE, PPCNONE,	{RA, RS, RB}},
{"xor.",	XRC(31,316,1),	X_MASK,	     PPE|COM|PPCVLE, PPCNONE,	{RA, RS, RB}},
...
{"mfxer",	XSPR(31,339,  1), XSPR_MASK, PPE|COM|PPCVLE, PPCNONE,	{RT}},
{"mfrtcu",	XSPR(31,339,  4), XSPR_MASK, PPE|COM,	TITAN,  	{RT}},
{"mfrtcl",	XSPR(31,339,  5), XSPR_MASK, PPE|COM,	TITAN,  	{RT}},
{"mfdec",	XSPR(31,339,  6), XSPR_MASK, MFDEC1,	PPCNONE,	{RT}},
{"mflr",	XSPR(31,339,  8), XSPR_MASK, PPE|COM|PPCVLE, PPCNONE,	{RT}},
{"mfctr",	XSPR(31,339,  9), XSPR_MASK, PPE|COM|PPCVLE, PPCNONE,	{RT}},
{"mftid",	XSPR(31,339, 17), XSPR_MASK, POWER,	PPCNONE,	{RT}},
{"mfdsisr",	XSPR(31,339, 18), XSPR_MASK, PPE|COM,	TITAN,  	{RT}},
{"mfdar",	XSPR(31,339, 19), XSPR_MASK, PPE|COM,	TITAN,  	{RT}},
{"mfdec",	XSPR(31,339, 22), XSPR_MASK, PPE|MFDEC2,MFDEC1,		{RT}},
{"mfsdr0",	XSPR(31,339, 24), XSPR_MASK, POWER,	PPCNONE,	{RT}},
{"mfsdr1",	XSPR(31,339, 25), XSPR_MASK, PPE|COM,	TITAN,  	{RT}},
{"mfsrr0",	XSPR(31,339, 26), XSPR_MASK, PPE|COM,	PPCNONE,	{RT}},
{"mfsrr1",	XSPR(31,339, 27), XSPR_MASK, PPE|COM,	PPCNONE,	{RT}},
{"mfcfar",	XSPR(31,339, 28), XSPR_MASK, POWER6,	PPCNONE,	{RT}},
{"mfpid",	XSPR(31,339, 48), XSPR_MASK, PPE|BOOKE|PPCVLE, PPCNONE,	{RT}},
...
{"mfedr",	XSPR(31,339, 61), XSPR_MASK, PPE, PPCNONE,      	{RT}},
{"mfesr",	XSPR(31,339, 62), XSPR_MASK, BOOKE|PPCVLE, PPCNONE,	{RT}},
{"mfisr",	XSPR(31,339, 62), XSPR_MASK, PPE, PPCNONE,	{RT}},
{"mfivpr",	XSPR(31,339, 63), XSPR_MASK, PPE|BOOKE|PPCVLE, PPCNONE,	{RT}},
...
{"mfsprg",	XSPR(31,339,256), XSPRG_MASK, PPE|PPC|PPCVLE, PPCNONE,	{RT, SPRG}},
...
{"mfsprg0",	XSPR(31,339,272), XSPR_MASK, PPE|PPC|PPCVLE, PPCNONE,	{RT}},
...
{"mfpir",	XSPR(31,339,286), XSPR_MASK, PPE|BOOKE|PPCVLE, PPCNONE,	{RT}},
{"mfpvr",	XSPR(31,339,287), XSPR_MASK, PPE|PPC|PPCVLE, PPCNONE,	{RT}},
{"mfdbsr",	XSPR(31,339,304), XSPR_MASK, BOOKE|PPCVLE, PPCNONE,	{RT}},
{"mfdbcr",	XSPR(31,339,308), XSPR_MASK, PPE,      PPCNONE, 	{RT}},
{"mfdbcr0",	XSPR(31,339,308), XSPR_MASK, PPE|BOOKE|PPCVLE, PPCNONE,	{RT}},
...
{"mfdacr",	XSPR(31,339,316), XSPR_MASK, PPE, PPCNONE,    	        {RT}},
{"mfdac1",	XSPR(31,339,316), XSPR_MASK, PPE|BOOKE|PPCVLE, PPCNONE,	{RT}},
...
{"mftsr",	XSPR(31,339,336), XSPR_MASK, PPE|BOOKE|PPCVLE, PPCNONE,	{RT}},
{"mftcr",	XSPR(31,339,340), XSPR_MASK, PPE|BOOKE|PPCVLE, PPCNONE,	{RT}},
...
{"mfspr",	X(31,339),	X_MASK,      PPE|COM|PPCVLE, PPCNONE,	{RT, SPR}},
...
{"dcbq",	X(31,406),	X_MASK,     PPE,	PPCNONE,	{RT, RA, RB}},

{"sthx",	X(31,407),	X_MASK,      PPE|COM|PPCVLE, PPCNONE,	{RS, RA0, RB}},

{"orc",		XRC(31,412,0),	X_MASK,      PPE|COM|PPCVLE, PPCNONE,	{RA, RS, RB}},
{"orc.",	XRC(31,412,1),	X_MASK,      PPE|COM|PPCVLE, PPCNONE,	{RA, RS, RB}},
...
{"mr",		XRC(31,444,0),	X_MASK,      PPE|COM|PPCVLE, PPCNONE,	{RA, RS, RBS}},
{"or",		XRC(31,444,0),	X_MASK,      PPE|COM|PPCVLE, PPCNONE,	{RA, RS, RB}},
{"mr.",		XRC(31,444,1),	X_MASK,      PPE|COM|PPCVLE, PPCNONE,	{RA, RS, RBS}},
{"or.",		XRC(31,444,1),	X_MASK,      PPE|COM|PPCVLE, PPCNONE,	{RA, RS, RB}},
...
{"mtxer",	XSPR(31,467,  1), XSPR_MASK, PPE|COM|PPCVLE, PPCNONE,	{RS}},
{"mtlr",	XSPR(31,467,  8), XSPR_MASK, PPE|COM|PPCVLE, PPCNONE,	{RS}},
{"mtctr", 	XSPR(31,467,  9), XSPR_MASK, PPE|COM|PPCVLE, PPCNONE,	{RS}},
...
{"mtdec",	XSPR(31,467, 22), XSPR_MASK, PPE|COM,	PPCNONE,	{RS}},
{"mtsdr0",	XSPR(31,467, 24), XSPR_MASK, POWER,	PPCNONE,	{RS}},
{"mtsdr1",	XSPR(31,467, 25), XSPR_MASK, COM,	TITAN,  	{RS}},
{"mtsrr0",	XSPR(31,467, 26), XSPR_MASK, PPE|COM|PPCVLE, PPCNONE,	{RS}},
{"mtsrr1",	XSPR(31,467, 27), XSPR_MASK, PPE|COM|PPCVLE, PPCNONE,	{RS}},
...
{"mtedr",	XSPR(31,467, 61), XSPR_MASK, PPE, PPCNONE,      	{RS}},
{"mtdear",	XSPR(31,467, 61), XSPR_MASK, BOOKE|PPCVLE, PPCNONE,	{RS}},
{"mtisr",	XSPR(31,467, 62), XSPR_MASK, PPE,       PPCNONE,       	{RS}},
{"mtesr",	XSPR(31,467, 62), XSPR_MASK, BOOKE|PPCVLE, PPCNONE,	{RS}},
{"mtivpr",	XSPR(31,467, 63), XSPR_MASK, PPE|BOOKE|PPCVLE, PPCNONE,	{RS}},
...
{"mtsprg",	XSPR(31,467,256), XSPRG_MASK, PPE|PPC|PPCVLE, PPCNONE,	{SPRG, RS}},
{"mtsprg0",	XSPR(31,467,272), XSPR_MASK, PPE|PPC|PPCVLE, PPCNONE,	{RS}},
...
{"mtpir",	XSPR(31,467,286), XSPR_MASK, PPE,	PPCNONE,	{RS}},
{"mtpvr",	XSPR(31,467,286), XSPR_MASK, PPE,	PPCNONE,	{RS}},
{"mtdbsr",	XSPR(31,467,304), XSPR_MASK, BOOKE|PPCVLE, PPCNONE,	{RS}},
{"mtdbcr",	XSPR(31,467,308), XSPR_MASK, PPE,  PPCNONE,		{RS}},
{"mtdbcr0",	XSPR(31,467,308), XSPR_MASK, PPE|BOOKE|PPCVLE, PPCNONE,	{RS}},
...
{"mtdacr",	XSPR(31,467,316), XSPR_MASK, PPE, PPCNONE,	{RS}},
...
{"mttsr",	XSPR(31,467,336), XSPR_MASK, PPE|BOOKE|PPCVLE, PPCNONE,	{RS}},
{"mttcr",	XSPR(31,467,340), XSPR_MASK, PPE|BOOKE|PPCVLE, PPCNONE,	{RS}},
...
{"mtdbsr",	XSPR(31,467,1008), XSPR_MASK, PPE|PPC403,PPCNONE,	{RS}},
...
{"mtspr",	X(31,467),	X_MASK,      PPE|COM|PPCVLE, PPCNONE,	{SPR, RS}},
 
{"dcbi",	X(31,470),	XRT_MASK,    PPE|PPC|PPCVLE, PPCNONE,	{RA0, RB}},

{"nand",	XRC(31,476,0),	X_MASK,      PPE|COM|PPCVLE, PPCNONE,	{RA, RS, RB}},
{"nand.",	XRC(31,476,1),	X_MASK,      PPE|COM|PPCVLE, PPCNONE,	{RA, RS, RB}},
...
{"subfco",	XO(31,8,1,0),	XO_MASK,     PPE|PPCCOM|PPCVLE, PPCNONE,	{RT, RA, RB}},
{"sfo",		XO(31,8,1,0),	XO_MASK,     PWRCOM,	PPCNONE,	{RT, RA, RB}},
{"subco",	XO(31,8,1,0),	XO_MASK,     PPE|PPCCOM|PPCVLE, PPCNONE,	{RT, RB, RA}},
{"subfco.",	XO(31,8,1,1),	XO_MASK,     PPE|PPCCOM|PPCVLE, PPCNONE,	{RT, RA, RB}},
{"sfo.",	XO(31,8,1,1),	XO_MASK,     PWRCOM,	PPCNONE,	{RT, RA, RB}},
{"subco.",	XO(31,8,1,1),	XO_MASK,     PPE|PPCCOM|PPCVLE, PPCNONE,	{RT, RB, RA}},
 
{"addco",	XO(31,10,1,0),	XO_MASK,     PPE|PPCCOM|PPCVLE, PPCNONE,	{RT, RA, RB}},
{"ao",		XO(31,10,1,0),	XO_MASK,     PWRCOM,	PPCNONE,	{RT, RA, RB}},
{"addco.",	XO(31,10,1,1),	XO_MASK,     PPE|PPCCOM|PPCVLE, PPCNONE,	{RT, RA, RB}},
...
{"srw",		XRC(31,536,0),	X_MASK,  PPE|PPCCOM|PPCVLE, PPCNONE,	{RA, RS, RB}},
{"sr",		XRC(31,536,0),	X_MASK,      PWRCOM,	PPCNONE,	{RA, RS, RB}},
{"srw.",	XRC(31,536,1),	X_MASK,  PPE|PPCCOM|PPCVLE, PPCNONE,	{RA, RS, RB}},
...
{"subfo",	XO(31,40,1,0),	XO_MASK,     PPE|PPC,	PPCNONE,	{RT, RA, RB}},
{"subo",	XO(31,40,1,0),	XO_MASK,     PPE|PPC,	PPCNONE,	{RT, RB, RA}},
{"subfo.",	XO(31,40,1,1),	XO_MASK,     PPE|PPC,	PPCNONE,	{RT, RA, RB}},
{"subo.",	XO(31,40,1,1),	XO_MASK,     PPE|PPC,	PPCNONE,	{RT, RB, RA}},

{"tlbsync",	X(31,566),	0xffffffff, PPC|PPCVLE, PPCNONE,	{0}},

{"lfsux",	X(31,567),	X_MASK,      COM,	PPCEFS,		{FRT, RAS, RB}},

{"srvd",	XRC(31,571,0),	X_MASK,       PPEX|PPC64|PPCVLE, PPCNONE,	{VDA, VDS, RB}},
{"srvd.",	XRC(31,571,1),	X_MASK,       PPEX|PPC64|PPCVLE, PPCNONE,	{VDA, VDS, RB}},
...
{"sync",	X(31,598),	XSYNC_MASK, PPE|PPCCOM|PPCVLE, BOOKE|PPC476, {LS}},
...
{"nego",	XO(31,104,1,0),	XORB_MASK,   PPE|COM|PPCVLE, PPCNONE,	{RT, RA}},
{"nego.",	XO(31,104,1,1),	XORB_MASK,   PPE|COM|PPCVLE, PPCNONE,	{RT, RA}},
...
{"subfeo",	XO(31,136,1,0),	XO_MASK, PPE|PPCCOM|PPCVLE, PPCNONE,	{RT, RA, RB}},
{"sfeo",	XO(31,136,1,0),	XO_MASK,     PWRCOM,	PPCNONE,	{RT, RA, RB}},
{"subfeo.",	XO(31,136,1,1),	XO_MASK, PPE|PPCCOM|PPCVLE, PPCNONE,	{RT, RA, RB}},
{"sfeo.",	XO(31,136,1,1),	XO_MASK,     PWRCOM,	PPCNONE,	{RT, RA, RB}},

{"addeo",	XO(31,138,1,0),	XO_MASK, PPE|PPCCOM|PPCVLE, PPCNONE,	{RT, RA, RB}},
{"aeo",		XO(31,138,1,0),	XO_MASK,     PWRCOM,	PPCNONE,	{RT, RA, RB}},
{"addeo.",	XO(31,138,1,1),	XO_MASK, PPE|PPCCOM|PPCVLE, PPCNONE,	{RT, RA, RB}},
...
{"subfzeo",	XO(31,200,1,0),	XORB_MASK, PPE|PPCCOM|PPCVLE, PPCNONE,	{RT, RA}},
{"sfzeo",	XO(31,200,1,0),	XORB_MASK,   PWRCOM,	PPCNONE,	{RT, RA}},
{"subfzeo.",	XO(31,200,1,1),	XORB_MASK, PPE|PPCCOM|PPCVLE, PPCNONE,	{RT, RA}},
{"sfzeo.",	XO(31,200,1,1),	XORB_MASK,   PWRCOM,	PPCNONE,	{RT, RA}},

{"addzeo",	XO(31,202,1,0),	XORB_MASK, PPE|PPCCOM|PPCVLE, PPCNONE,	{RT, RA}},
{"azeo",	XO(31,202,1,0),	XORB_MASK,   PWRCOM,	PPCNONE,	{RT, RA}},
{"addzeo.",	XO(31,202,1,1),	XORB_MASK, PPE|PPCCOM|PPCVLE, PPCNONE,	{RT, RA}},
...
{"subfmeo",	XO(31,232,1,0),	XORB_MASK,   PPE|PPCCOM,	PPCNONE,	{RT, RA}},
{"sfmeo",	XO(31,232,1,0),	XORB_MASK,   PWRCOM,	PPCNONE,	{RT, RA}},
{"subfmeo.",	XO(31,232,1,1),	XORB_MASK,   PPE|PPCCOM,	PPCNONE,	{RT, RA}},
...
{"addmeo",	XO(31,234,1,0),	XORB_MASK,   PPE|PPCCOM|PPCVLE, PPCNONE,	{RT, RA}},
{"ameo",	XO(31,234,1,0),	XORB_MASK,   PWRCOM,	PPCNONE,	{RT, RA}},
{"addmeo.",	XO(31,234,1,1),	XORB_MASK,   PPE|PPCCOM|PPCVLE, PPCNONE,	{RT, RA}},
...
{"addo",	XO(31,266,1,0),	XO_MASK, PPE|PPCCOM|PPCVLE, PPCNONE,	{RT, RA, RB}},
{"caxo",	XO(31,266,1,0),	XO_MASK,     PWRCOM,	PPCNONE,	{RT, RA, RB}},
{"addo.",	XO(31,266,1,1),	XO_MASK, PPE|PPCCOM|PPCVLE, PPCNONE,	{RT, RA, RB}},
...
{"sraw",	XRC(31,792,0),	X_MASK,  PPE|PPCCOM|PPCVLE, PPCNONE,	{RA, RS, RB}},
{"sra",		XRC(31,792,0),	X_MASK,      PWRCOM,	PPCNONE,	{RA, RS, RB}},
{"sraw.",	XRC(31,792,1),	X_MASK,	 PPE|PPCCOM|PPCVLE, PPCNONE,	{RA, RS, RB}},
...
{"srawi",	XRC(31,824,0),	X_MASK,  PPE|PPCCOM|PPCVLE, PPCNONE,	{RA, RS, SH}},
{"srai",	XRC(31,824,0),	X_MASK,      PWRCOM,	PPCNONE,	{RA, RS, SH}},
{"srawi.",	XRC(31,824,1),	X_MASK,	 PPE|PPCCOM|PPCVLE, PPCNONE,	{RA, RS, SH}},
...
{"extsh",	XRC(31,922,0),	XRB_MASK,    PPE|PPCCOM|PPCVLE, PPCNONE,	{RA, RS}},
{"exts",	XRC(31,922,0),	XRB_MASK,    PWRCOM,	PPCNONE,	{RA, RS}},
{"extsh.",	XRC(31,922,1),	XRB_MASK,    PPE|PPCCOM|PPCVLE, PPCNONE,	{RA, RS}},
...
{"extsb",	XRC(31,954,0),	XRB_MASK, PPE|PPC|PPCVLE,	PPCNONE,	{RA, RS}},
{"extsb.",	XRC(31,954,1),	XRB_MASK, PPE|PPC|PPCVLE,	PPCNONE,	{RA, RS}},
...
{"dcbz",	X(31,1014),	XRT_MASK,    PPE|PPC|PPCVLE, PPCNONE,	{RA0, RB}},
...
{"lwz",		OP(32),		OP_MASK,     PPE|PPCCOM,	PPCNONE,	{RT, D, RA0}},
{"l",		OP(32),		OP_MASK,     PWRCOM,	PPCNONE,	{RT, D, RA0}},

{"lwzu",	OP(33),		OP_MASK,     PPE|PPCCOM,	PPCNONE,	{RT, D, RAL}},
{"lu",		OP(33),		OP_MASK,     PWRCOM,	PPCNONE,	{RT, D, RA0}},

{"lbz",		OP(34),		OP_MASK,     PPE|COM,	PPCNONE,	{RT, D, RA0}},

{"lbzu",	OP(35),		OP_MASK,     PPE|COM,	PPCNONE,	{RT, D, RAL}},

{"stw",		OP(36),		OP_MASK,     PPE|PPCCOM,	PPCNONE,	{RS, D, RA0}},
{"st",		OP(36),		OP_MASK,     PWRCOM,	PPCNONE,	{RS, D, RA0}},

{"stwu",	OP(37),		OP_MASK,     PPE|PPCCOM,	PPCNONE,	{RS, D, RAS}},
{"stu",		OP(37),		OP_MASK,     PWRCOM,	PPCNONE,	{RS, D, RA0}},

{"stb",		OP(38),		OP_MASK,     PPE|COM,	PPCNONE,	{RS, D, RA0}},

{"stbu",	OP(39),		OP_MASK,     PPE|COM,	PPCNONE,	{RS, D, RAS}},

{"lhz",		OP(40),		OP_MASK,     PPE|COM,	PPCNONE,	{RT, D, RA0}},

{"lhzu",	OP(41),		OP_MASK,     PPE|COM,	PPCNONE,	{RT, D, RAL}},

{"lha",		OP(42),		OP_MASK,     COM,	PPCNONE,	{RT, D, RA0}},

{"lhau",	OP(43),		OP_MASK,     COM,	PPCNONE,	{RT, D, RAL}},

{"sth",		OP(44),		OP_MASK,     PPE|COM,	PPCNONE,	{RS, D, RA0}},

{"sthu",	OP(45),		OP_MASK,     PPE|COM,	PPCNONE,	{RS, D, RAS}},
...
{"lsku",		CTX(58,3),	CTX_MASK,   PPEX, PPCNONE, {RT, DD, RA0}},
{"lcxu",		CTX(58,7),	CTX_MASK,   PPEX, PPCNONE, {RT, DD, RA0}},
...
{"stsku",	CTX(62,3),		CTX_MASK,   PPEX,	PPCNONE,	{RS, DD, RAS }},
{"stcxu",	CTX(62,7),	CTX_MASK,     PPEX,	PPCNONE,	{RS, DD, RAS }},
...
{"extldi",   4,	PPEX|PPC64,	"rldicr %0,%1,%3,(%2)-1"},
{"extldi.",  4,	PPEX|PPC64,	"rldicr. %0,%1,%3,(%2)-1"},
{"extrdi",   4,	PPEX|PPC64,	"rldicl %0,%1,((%2)+(%3))&((%2)+(%3)<>64),64-(%2)"},
{"extrdi.",  4,	PPEX|PPC64,	"rldicl. %0,%1,((%2)+(%3))&((%2)+(%3)<>64),64-(%2)"},
{"insrdi",   4,	PPEX|PPC64,	"rldimi %0,%1,64-((%2)+(%3)),%3"},
{"insrdi.",  4,	PPEX|PPC64,	"rldimi. %0,%1,64-((%2)+(%3)),%3"},
{"rotrdi",   3,	PPEX|PPC64,	"rldicl %0,%1,(-(%2)!63)&((%2)|63),0"},
{"rotrdi.",  3,	PPEX|PPC64,	"rldicl. %0,%1,(-(%2)!63)&((%2)|63),0"},
{"sldi",     3,	PPEX|PPC64,	"rldicr %0,%1,%2,63-(%2)"},
{"sldi.",    3,	PPEX|PPC64,	"rldicr. %0,%1,%2,63-(%2)"},
{"srdi",     3,	PPEX|PPC64,	"rldicl %0,%1,(-(%2)!63)&((%2)|63),%2"},
{"srdi.",    3,	PPEX|PPC64,	"rldicl. %0,%1,(-(%2)!63)&((%2)|63),%2"},
{"clrrdi",   3,	PPEX|PPC64,	"rldicr %0,%1,0,63-(%2)"},
{"clrrdi.",  3,	PPEX|PPC64,	"rldicr. %0,%1,0,63-(%2)"},
{"clrlsldi", 4,	PPC64,	"rldic %0,%1,%3,(%2)-(%3)"},
{"clrlsldi.",4, PPC64,	"rldic. %0,%1,%3,(%2)-(%3)"},
{"stcxtu",   2, PPEX, "stcxu %0,%1"},

{"extlwi",   4,	PPE|PPCCOM,	"rlwinm %0,%1,%3,0,(%2)-1"},
{"extlwi.",  4,	PPE|PPCCOM,	"rlwinm. %0,%1,%3,0,(%2)-1"},
{"extrwi",   4,	PPE|PPCCOM,	"rlwinm %0,%1,((%2)+(%3))&((%2)+(%3)<>32),32-(%2),31"},
{"extrwi.",  4,	PPE|PPCCOM,	"rlwinm. %0,%1,((%2)+(%3))&((%2)+(%3)<>32),32-(%2),31"},
{"inslwi",   4,	PPE|PPCCOM,	"rlwimi %0,%1,(-(%3)!31)&((%3)|31),%3,(%2)+(%3)-1"},
{"inslwi.",  4,	PPE|PPCCOM,	"rlwimi. %0,%1,(-(%3)!31)&((%3)|31),%3,(%2)+(%3)-1"},
{"insrwi",   4,	PPE|PPCCOM,	"rlwimi %0,%1,32-((%2)+(%3)),%3,(%2)+(%3)-1"},
{"insrwi.",  4,	PPE|PPCCOM,	"rlwimi. %0,%1,32-((%2)+(%3)),%3,(%2)+(%3)-1"},
{"rotrwi",   3,	PPE|PPCCOM,	"rlwinm %0,%1,(-(%2)!31)&((%2)|31),0,31"},
{"rotrwi.",  3,	PPE|PPCCOM,	"rlwinm. %0,%1,(-(%2)!31)&((%2)|31),0,31"},
{"clrbwi",   3,	PPE|PPCCOM,	"rlwinm %0,%1,0,(((%2)+1)&31),(((%2)+32-1)&31)"},
{"clrbwi.",  3,	PPE|PPCCOM,	"rlwinm. %0,%1,0,(((%2)+1)&31),(((%2)+32-1)&31)"},
{"slwi",     3,	PPE|PPCCOM,	"rlwinm %0,%1,%2,0,31-(%2)"},
{"sli",      3,	PWRCOM,	"rlinm %0,%1,%2,0,31-(%2)"},
{"slwi.",    3,	PPE|PPCCOM,	"rlwinm. %0,%1,%2,0,31-(%2)"},
{"sli.",     3,	PWRCOM,	"rlinm. %0,%1,%2,0,31-(%2)"},
{"srwi",     3,	PPE|PPCCOM,	"rlwinm %0,%1,(-(%2)!31)&((%2)|31),%2,31"},
{"sri",      3,	PWRCOM,	"rlinm %0,%1,(-(%2)!31)&((%2)|31),%2,31"},
{"srwi.",    3,	PPE|PPCCOM,	"rlwinm. %0,%1,(-(%2)!31)&((%2)|31),%2,31"},
{"sri.",     3,	PWRCOM,	"rlinm. %0,%1,(-(%2)!31)&((%2)|31),%2,31"},
{"clrrwi",   3,	PPE|PPCCOM,	"rlwinm %0,%1,0,0,31-(%2)"},
{"clrrwi.",  3,	PPE|PPCCOM,	"rlwinm. %0,%1,0,0,31-(%2)"},
{"clrlslwi", 4,	PPE|PPCCOM,	"rlwinm %0,%1,%3,(%2)-(%3),31-(%3)"},
{"clrlslwi.",4, PPE|PPCCOM,	"rlwinm. %0,%1,%3,(%2)-(%3),31-(%3)"},
